...
a.actSize);"chnk"==a.upState&&a.chnkNum?(a.pBar.show((a.startByte+c)/a.size),u(c-a.lastsz),a.lastsz=c):"upld"==a.upState&&(a.pBar.show(b.loaded/b.total),c=Math.round(b.loaded/b.total*a.size),u(c-a.lastsz),a.lastsz=c)}},chng:function(b){4>this.readyState||(200!==this.status?(u(a.size-a.startByte-a.lastsz),a.lastsz=a.size,0===this.status?(a.pBar.msg("-- "+js_vars.h5uM.aborted,!0),a.doChnk?(a.upState="abrt",l()):d()):(a.pBar.msg(this.statusText||this.status,!0),d())):200===this.status&&(a.doChnk?l():
f()))},fail:function(b){a.pBar.msg(a.xhr.responseText,!0)}};a.abort=function(b){a.xhr?(b=a.xhr.readyState,4>b&&0!==b?a.xhr.abort():g.abrt()):(a.pBar.remove(),a.pBar=null)};a.pBar=new H(a,a.doChnk?"chunked":"");var h="",m=b.name.split(".");1==m.length||"object"==typeof js_vars.allowed_file_types&&0>js_vars.allowed_file_types.indexOf(m.pop().toLowerCase())?h='<img src="'+js_vars.H5uPath+'css/info.png" class="infog" onclick="showAllowedExts();" /> '+js_vars.h5uM.type_err:b.size>js_vars.maxfilesize&&
(h=js_vars.h5uM.size_err);if(h)a.pBar.msg(h,!0),u(b.size),a.xhr=null,n(!0,"errM");else return a.xhr.onreadystatechange=g.chng,a.xhr.upload.onerror=g.fail,a.xhr.upload.onprogress=g.prog,a.doChnk?l():f(),this}var q,D,B,r,e=[],t=js_vars.concurrent,g=!1,h=0,x=0,y=0,w=0,z=0,A=0,l,m;d.H5uSetup=function(){var b=$id("upload_field"),a=$id("dropArea");d.File&&d.FileList?(r=$id("qcount"),l=$id("qstop"),m=$id("qgocan"),b&&($ae(b,"click",F),$ae(b,"change",C)),b=new XMLHttpRequest,b.upload&&($ae(a,"dragover",v),
$ae(a,"dragleave",v),$ae(a,"drop",C),a.style.display="block",q=$id("totprogress"),B=$id("fprogress")),h5u_albSel=document.getElementsByName("h5u_album")[0]):($id("h5upldrow").style.display="none",$id("navailrow").style.display="table-row")};d.H5uQctrl={stop:function(){g=!0;l.style.display="none";m.style.display="inline-block"},go:function(){g=!1;l.style.display="inline-block";m.style.display="none";if(stagger)n(!1,"go");else for(;e.length&&h<t;)n(!1,"go")},cancel:function(){e.length=0;g=!1;m.style.display=
"none";r.innerHTML=0;h||E()}}})(window,"uniload.php","autorient flistitl title caption keywords user1 user2 user3 user4".split(" "));function showAllowedExts(){alert(js_vars.h5uM.extallow+js_vars.allowed_file_types.join(", "))}function shide_titlrow(d){var k=$id("titlrow");d.checked?k.style.display="none":k.style.display="table-row"}$(document).ready(function(){H5uSetup()});
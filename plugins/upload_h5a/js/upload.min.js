...
"flistitl title caption keywords user1 user2 user3 user4".split(" "));function showAllowedExts(){alert(js_vars.h5uM.extallow+js_vars.allowed_file_types.join(", "))}function shide_titlrow(d){var f=$id("titlrow");d.checked?f.style.display="none":f.style.display="table-row"}$(document).ready(function(){H5uSetup()});
...
(function(d,f,m){function E(b){h5u_albSel.value||(b.stopPropagation(),b.preventDefault(),alert(js_vars.h5uM.selAlb))}function v(b){b.stopPropagation();b.preventDefault();b.target.className="dragover"==b.type?"hover":""}function A(b){var a,c;B=q.offsetWidth;v(b);if(h5u_albSel.value){w&&(w=x=y=0);b=b.target.files||b.dataTransfer.files;for(a=0;c=b[a];a++)x+=c.size,e.push(c),r.innerHTML=e.length,stagger||n(!1,"fsel");stagger&&n(!1,"fsel");e.length>t&&(l.style.display="inline-block")}else alert(js_vars.h5uM.selAlb)}
function C(){k||(w=1,typeof("function"==H5up_done)&&H5up_done(D))}function n(b,a){b&&(--g||C());if(!k&&e.length&&(!t||g<t)){var c=e.shift();new F(c);g++;r.innerHTML=e.length}0>=e.length&&(l.style.display="none",h.style.display="none")}function G(b,a){var c=this;c.show=function(a){c.pb.style.backgroundPosition=Math.floor(c.pb.offsetWidth*a)+"px 0";1===a&&(c.pb.innerHTML=c.fObj.fileName,c.pb.className="indeterm")};c.msg=function(a,b){c.pb.innerHTML+="<br />"+a;b&&(c.pb.className="failure",D++)};c.remove=
function(){c.pb._ufo=null;z.removeChild(c.pb);c.fObj=null};c.pb=z.appendChild(document.createElement("p"));a&&(c.pb.className=a);c.pb.appendChild(document.createTextNode(b.fileName));c.pb.innerHTML+='<img src="'+js_vars.H5uPath+'css/redX.png" class="abortX" onclick="this.parentNode._ufo.abort(true);" />';c.pb._ufo=b;c.fObj=b;return this}function u(b){!q||0>b||(y+=b,q.style.backgroundPosition=Math.floor(B*y/x)+"px 0")}function H(){var b={},a;for(a in m){var c=m[a];var d=$id(c);if(d)switch(d.type){case "checkbox":b[c]=
...
a.chnkNum?(a.pBar.show((a.startByte+c)/a.size),u(c-a.lastsz),a.lastsz=c):"upld"==a.upState&&(a.pBar.show(b.loaded/b.total),c=Math.round(b.loaded/b.total*a.size),u(c-a.lastsz),a.lastsz=c)}},chng:function(b){4>this.readyState||(200!==this.status?(u(a.size-a.startByte-a.lastsz),a.lastsz=a.size,0===this.status?(a.pBar.msg("-- "+js_vars.h5uM.aborted,!0),a.doChnk?(a.upState="abrt",k()):d()):(a.pBar.msg(this.statusText||this.status,!0),d())):200===this.status&&(a.doChnk?k():l()))},fail:function(b){a.pBar.msg(a.xhr.responseText,
!0)}};a.abort=function(b){a.xhr?(b=a.xhr.readyState,4>b&&0!==b?a.xhr.abort():g.abrt()):(a.pBar.remove(),a.pBar=null)};a.pBar=new G(a,a.doChnk?"chunked":"");var h="",m=b.name.split(".");1==m.length||"object"==typeof js_vars.allowed_file_types&&0>js_vars.allowed_file_types.indexOf(m.pop().toLowerCase())?h='<img src="'+js_vars.H5uPath+'css/info.png" class="infog" onclick="showAllowedExts();" /> '+js_vars.h5uM.type_err:b.size>js_vars.maxfilesize&&(h=js_vars.h5uM.size_err);if(h)a.pBar.msg(h,!0),u(b.size),
a.xhr=null,n(!0,"errM");else return a.xhr.onreadystatechange=g.chng,a.xhr.upload.onerror=g.fail,a.xhr.upload.onprogress=g.prog,a.doChnk?k():l(),this}var q,B,z,r,e=[],t=js_vars.concurrent,k=!1,g=0,x=0,y=0,w=0,D=0,l,h;d.H5uSetup=function(){var b=$id("upload_field"),a=$id("dropArea");d.File&&d.FileList?(r=$id("qcount"),l=$id("qstop"),h=$id("qgocan"),b&&($ae(b,"click",E),$ae(b,"change",A)),b=new XMLHttpRequest,b.upload&&($ae(a,"dragover",v),$ae(a,"dragleave",v),$ae(a,"drop",A),a.style.display="block",
q=$id("totprogress"),z=$id("fprogress")),h5u_albSel=document.getElementsByName("h5u_album")[0]):($id("h5upldrow").style.display="none",$id("navailrow").style.display="table-row")};d.H5uQctrl={stop:function(){k=!0;l.style.display="none";h.style.display="inline-block"},go:function(){k=!1;l.style.display="inline-block";h.style.display="none";if(stagger)n(!1,"go");else for(;e.length&&g<t;)n(!1,"go")},cancel:function(){e.length=0;k=!1;h.style.display="none";r.innerHTML=0;g||C()}}})(window,"uniload.php",

...
$lang_install['mysql_create_db'] = 'Создать новую базу данных';
$lang_install['mysql_db_name'] = 'Имя базы данных';
$lang_install['mysql_error'] = 'Ошибка базы данных: ';
$lang_install['mysql_host'] = 'Хост базы данных<br />(обычно подходит localhost)';
$lang_install['mysql_username'] = 'Имя пользователя базы данных';
$lang_install['mysql_password'] = 'Пароль базы данных';
$lang_install['mysql_no_create_db'] = 'Не могу создать базу данных.';
$lang_install['mysql_no_sel_dbs'] = 'Не могу получить список существующих баз данных';
$lang_install['mysql_succ'] = 'Успешное подключение к базе данных';
$lang_install['mysql_tbl_pref'] = 'Префикс базы данных';
$lang_install['mysql_test_connection'] = 'Тестировать соединение';
$lang_install['mysql_wrong_db'] = 'Не могу найти базу данных с названием \'%s\', пожалуйста, проверьте введенное значение';
...
$lang_install['no_mysql_conn'] = 'Не могу создать подключение к базе данных, пожалуйста, проверьте данные настроек %s';
$lang_install['no_mysql_support'] = 'PHP не имеет поддержку %s.';
...
$lang_install['sect_mysql_info'] = 'Данный раздел требует информацию, о способе доступа к Вашей базе данных.<br />Если Вы не знаете, как их заполнить, обратитесь к поддержке Вашего хостинга.';
...
$lang_install['title_mysql_db_sel'] = 'Выбор базы данных %s';
$lang_install['title_mysql_pop'] = 'Создание структуры базы данных';
$lang_install['title_mysql_user'] = 'Аутентификация пользователя базы данных';

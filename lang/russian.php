...
$lang_translation_info['trans_name'] = 'Siava';
$lang_translation_info['trans_email'] = 'admin@siava.ru';
$lang_translation_info['trans_website'] = 'https://siava.ru';
$lang_translation_info['trans_date'] = '2020-06-29';
...
$lang_errors['quota_exceeded'] = 'Дисковая квота превышена.';
$lang_errors['quota_exceeded_details'] = 'Для Вас дисковая квота составляет [quota]К, Ваши файлы сейчас занимают [space]К, добавление этого файла приведёт к превышению Вашей квоты.';
...
$lang_errors['captcha_error'] = 'Код подтверждения не совпадает';
$lang_errors['login_needed'] = 'Необходимо %sзарегистрироваться%s/%sвойти%s, чтобы получить доступ к этой странице';
$lang_errors['error'] = 'Ошибка';
$lang_errors['critical_error'] = 'Критическая ошибка';
$lang_errors['access_thumbnail_only'] = 'Вы можете просматривать только страницы с миниатюрами.';
$lang_errors['access_intermediate_only'] = 'У Вас отсутствуют прав на просмотр полноразмерных изображений.';
$lang_errors['access_none'] = 'У Вас отсутствуют права на просмотр каких-либо изображений.';
$lang_errors['register_globals_title'] = 'Register Globals включена!';
$lang_errors['register_globals_warning'] = 'На Вашем сервере включена опция PHP register_globals, что является плохой идеей с точки зрения безопасности. Настоятельно рекомендуется её выключить.';
...
$lang_common['yes'] = 'Да';
$lang_common['no'] = 'Нет';
$lang_common['back'] = 'Назад';
$lang_common['continue'] = 'Продолжить';
$lang_common['information'] = 'Информация';
$lang_common['error'] = 'Ошибка';
$lang_common['check_uncheck_all'] = 'отметить/снять выделение';
$lang_common['confirm'] = 'Подтверждение';
$lang_common['captcha_help_title'] = 'Визуальное подтверждение (captcha)';
$lang_common['captcha_help'] = 'Для предотвращения спама, Вы должны подтвердить, что Вы человек, а не робот, введя отображаемый текст.<br />Регистр букв не имеет значения, Вы можете вводить прописные буквы.';
$lang_common['title'] = 'Название';
$lang_common['caption'] = 'Подпись';
$lang_common['keywords'] = 'Ключевые слова';
$lang_common['keywords_insert1'] = 'Ключевые слова (разделитель %s)';
$lang_common['keywords_insert2'] = 'Вставить из списка';
$lang_common['keyword_separator'] = 'Разделитель ключевых слов';
$lang_common['keyword_separators'] = array(' '=>'пробел', ','=>'запятая', ';'=>'точка с запятой');
$lang_common['owner_name'] = 'Имя владельца';
$lang_common['filename'] = 'Имя файла';
$lang_common['filesize'] = 'Размер файла';
$lang_common['album'] = 'Альбом';
$lang_common['file'] = 'Файл';
$lang_common['date'] = 'Дата';
$lang_common['help'] = 'Помощь';
$lang_common['close'] = 'Закрыть';
$lang_common['go'] = 'вперёд';
$lang_common['javascript_needed'] = 'Данная страница требует JavaScript. Пожалуйста, включите JavaScript в Вашем браузере.';
$lang_common['move_up'] = 'Двигать вверх';
$lang_common['move_down'] = 'Двигать вниз';
$lang_common['move_top'] = 'Переместить наверх';
$lang_common['move_bottom'] = 'Переместить вниз';
$lang_common['delete'] = 'Удалить';
$lang_common['edit'] = 'Править';
$lang_common['username_if_blank'] = 'Неизвестный пользователь';
$lang_common['albums_no_category'] = 'Альбомы без категорий';
$lang_common['personal_albums'] = '* Персональные альбомы';
$lang_common['select_album'] = 'Выбрать альбом';
$lang_common['ok'] = 'OK';
$lang_common['status'] = 'Статус';
$lang_common['apply_changes'] = 'Применить изменения';
$lang_common['done'] = 'Готово';
$lang_common['album_properties'] = 'Свойства альбома';
$lang_common['parent_category'] = 'Категория верхнего уровня';
$lang_common['edit_files'] = 'Править файлы';
$lang_common['thumbnail_view'] = 'Просмотр миниатюр';
$lang_common['album_manager'] = 'Управление альбомами';
$lang_common['more'] = 'ещё';
...
$lang_main_menu['adm_mode_title'] = 'Включить отображение инструментов администратора';
$lang_main_menu['adm_mode_lnk'] = 'Показать инструменты администратора';
$lang_main_menu['usr_mode_title'] = 'Отключить отображение инструментов администратора';
$lang_main_menu['usr_mode_lnk'] = 'Спрятать инструменты администратора';
...
$lang_main_menu['browse_by_date_lnk'] = 'По дате';
$lang_main_menu['browse_by_date_title'] = 'Смотреть по дате загрузки';
$lang_main_menu['contact_title'] = 'Связаться с %s';
$lang_main_menu['contact_lnk'] = 'Обратная связь';
$lang_main_menu['sidebar_title'] = 'Добавить боковую панель в Ваш браузер';
$lang_main_menu['sidebar_lnk'] = 'Боковая панель';
...
$lang_gallery_admin_menu['phpinfo_title'] = 'Содержит техническую информацию о Вашем сервере. Вас могут попросить предоставить эту информацию, когда Вы будите запрашивать помощь по галерее.';
$lang_gallery_admin_menu['update_database_lnk'] = 'Обновить базу данных';
$lang_gallery_admin_menu['update_database_title'] = 'Если Вы заменили системные файлы галереи, добавили модификации или обновили старую версию галереи на новую, убедитесь, что Вы обновили базу данных один раз. Это создаст необходимые таблицы и/или значения настроек в базе данных галереи.';
$lang_gallery_admin_menu['view_log_files_lnk'] = 'Просмотр лог файлов';
$lang_gallery_admin_menu['view_log_files_title'] = 'Coppermine может следить за различными действиями, которые совершают пользователи. Вы можете просматривать эти логи, если Вы включили запись логов в конфигурации галереи.';
$lang_gallery_admin_menu['check_versions_lnk'] = 'Проверить версии файлов';
$lang_gallery_admin_menu['check_versions_title'] = 'Проверить версии Ваших файлов, чтобы определить, заменили ли Вы все файлы после обновления, или исходные файлы Coppermine были обновлены после выхода данной версии.';
$lang_gallery_admin_menu['bridgemgr_lnk'] = 'Менеджер интеграции';
$lang_gallery_admin_menu['bridgemgr_title'] = 'Включает/выключает интеграцию (bridging) Coppermine галереи с другими приложениями (например Вашим форумом).';
$lang_gallery_admin_menu['pluginmgr_lnk'] = 'Менеджер плагинов';
$lang_gallery_admin_menu['pluginmgr_title'] = 'Менеджер плагинов';
$lang_gallery_admin_menu['overall_stats_lnk'] = 'Общая статистика';
$lang_gallery_admin_menu['overall_stats_title'] = 'Просмотреть общую статистику по браузерам, операционным системам и операционным системам (если соответствующая опция включена в конфигурации галереи).';
$lang_gallery_admin_menu['keywordmgr_lnk'] = 'Менеджер ключевых слов';
$lang_gallery_admin_menu['keywordmgr_title'] = 'Управление ключевыми словами (если соответствующая опция включена в конфигурации галереи).';
$lang_gallery_admin_menu['exifmgr_lnk'] = 'Менеджер EXIF';
$lang_gallery_admin_menu['exifmgr_title'] = 'Управление отображением EXIF (если соответствующая опция включена в конфигурации галереи).';
$lang_gallery_admin_menu['shownews_lnk'] = 'Показать новости';
$lang_gallery_admin_menu['shownews_title'] = 'Отображать новости с coppermine-gallery.net';
...
$lang_thumb_view['zipdownload_copyright'] = 'Пожалуйста, уважайте авторские права - распоряжайтесь файлами, которые Вы загрузили, так, как это предполагалось владельцем галереи';
$lang_thumb_view['zipdownload_username'] = 'Этот архив содержит сжатые файлы из избранного %s';
...
$lang_rate_pic['js_warning'] = 'Javascript должен быть включён для голосования';
$lang_rate_pic['already_voted'] = 'Вы уже проголосовали за это изображение.';
$lang_rate_pic['forbidden'] = 'Вы не можете голосовать за свои файлы.';
$lang_rate_pic['rollover_to_rate'] = 'Наведите, чтобы проголосовать за это изображение';
...
$lang_cpg_debug_output['debug_output'] = 'Вывод отладочной информации';
$lang_cpg_debug_output['select_all'] = 'Выбрать всё';
$lang_cpg_debug_output['copy_and_paste_instructions'] = 'Если Вы собираетесь просить о помощи на форумах Coppermine, скопируйте и вставьте эту отладочную информацию в Ваше сообщение вместе с сообщением об ошибке (если она есть). Размещайте отладочную информацию на форуме поддержки, только если отвечающий за поддержку пользователь попросил Вас об этом! Убедитесь, что Вы заменили все пароли на ***, перед созданием своего сообщения.';
$lang_cpg_debug_output['debug_output_explain'] = 'Примечание: Это только для информационных целей и не означает, что в галерее есть ошибка.';
$lang_cpg_debug_output['phpinfo'] = 'отобразить phpinfo';
$lang_cpg_debug_output['notices'] = 'Примечания';
$lang_cpg_debug_output['notices_help_admin'] = 'Предупреждения отображаются на данной странице, потому что Вы (как администратор галереи) преднамеренно включили данную опцию в конфигурации Coppermine. Они не означают, что что-то не так с Вашей галереей. Фактически они являются девелоперской функцией, которую должны задействовать только квалифицированные программисты, чтобы находить ошибки в коде. Если данные предупреждения Вас раздражают и/или Вы не понимаете, что данные предупреждения означают, отключите соответствующую опцию в конфигурации.';
$lang_cpg_debug_output['notices_help_non_admin'] = 'Отображение примечаний было преднамеренно включено администрацией. Это не означает, что что-то не так с Вашей стороны. Вы можете смело игнорировать примечания, отображаемые здесь.';
$lang_cpg_debug_output['show_hide'] = 'показать / скрыть';
...
$lang_version_alert['coppermine_news'] = 'Новости от coppermine-gallery.net';
$lang_version_alert['no_iframe'] = 'Ваш браузер не может отображать встроенные фреймы';
$lang_version_alert['hide'] = 'спрятать';
// for version update checks
$lang_version_alert['updates_available'] = 'Доступна более новая версия Coppermine.';
$lang_version_alert['view_updates'] = 'Просмотр обновлений';

$lang_create_tabs['previous'] = 'Предыдущий';
$lang_create_tabs['next'] = 'Следующий';
$lang_create_tabs['jump_to_page'] = 'Перейти к странице';

$lang_get_remote_file_by_url['no_data_returned'] = 'Данные не вернулись от %s';
$lang_get_remote_file_by_url['curl'] = 'CURL';
$lang_get_remote_file_by_url['fsockopen'] = 'Socket соединение (FSOCKOPEN)';
$lang_get_remote_file_by_url['fopen'] = 'fopen';
$lang_get_remote_file_by_url['curl_not_available'] = 'Curl не доступен на Вашем сервере';
$lang_get_remote_file_by_url['error_number'] = 'Ошибка номер: %s';
$lang_get_remote_file_by_url['error_message'] = 'Сообщение об ошибке: %s';

$lang_alb_select_box['only_empty_albums'] = 'Показать только пустые альбомы';
$lang_alb_select_box['all_albums'] = 'Показать все альбомы';
...
$lang_mailer['empty_message'] = 'Пустое сообщение';
...
$lang_mailer['invalid_address'] = 'Неверный адрес: ';
...
$lang_mailer['smtp_connect_failed'] = 'SMTP соединение не удалось.';
$lang_mailer['smtp_error'] = 'Ошибка SMTP-сервера: ';
$lang_mailer['variable_set'] = 'Невозможно установить или сбросить переменную: ';
$lang_mailer['extension_missing'] = 'Расширение отсутствует: ';
...
$lang_plugin_api['error_sleep'] = 'Не могу отключить плагин \'%s\'';
...
$lang_albmgr_php['title'] = 'Менеджер альбомов';
...
$lang_albmgr_php['delete_album'] = 'Удалить альбом';
...
$lang_albmgr_php['category_change'] = 'Если Вы измените категорию, Ваши изменения будут утеряны!';
$lang_albmgr_php['page_change'] = 'Если Вы перейдёте по ссылке выше, изменения будут утеряны!';
$lang_albmgr_php['cancel'] = 'Отмена';
$lang_albmgr_php['submit_reminder'] = 'Изменения сортировки не будут сохранены, пока Вы не нажмёте &quot;Применить изменения&quot;.';
$lang_albmgr_php['upload_files'] = 'Загрузить файлы в этот альбом';
}
...
$lang_banning_php['user_account'] = 'Учётная запись пользователя';
$lang_banning_php['email_address'] = 'Email адрес';
$lang_banning_php['ip_address'] = 'IP адрес';
$lang_banning_php['expires'] = 'Окончание';
$lang_banning_php['expiry_date'] = 'Дате окончания';
$lang_banning_php['expired'] = 'Истёк';
...
$lang_banning_php['skipping'] = 'Пропускаю эту команду.';
$lang_banning_php['lookup_ip'] = 'WHOIS для IP адреса';
$lang_banning_php['select_date'] = 'выберите дату';
$lang_banning_php['delete_comments'] = 'Удалить комментарии';
$lang_banning_php['current'] = 'текущий';
$lang_banning_php['all'] = 'все';
$lang_banning_php['none'] = 'никакой';
$lang_banning_php['view'] = 'посмотреть';
$lang_banning_php['ban_id'] = 'ID блокировки';
$lang_banning_php['existing_bans'] = 'Существующие блокировки';
$lang_banning_php['no_banning_when_bridged'] = 'На текущий момент Ваша галерея интегрирована с другим приложением. Используйте механизм блокировки основного приложения вместо механизма встроенного в Coppermine. Встроенный в Coppermine механизм интеграции применим с трудом когда активна интеграция.';
$lang_banning_php['records_on_page'] = '%d записей на %d странице(ах)';
$lang_banning_php['ascending'] = '[возрастание]';
$lang_banning_php['descending'] = '[убывание]';
$lang_banning_php['sort_by'] = 'Сортировать по';
$lang_banning_php['sorted_by'] = 'отсортировано по';
$lang_banning_php['ban_record_x_updated'] = 'Запись блокировки %s была обновлена';
$lang_banning_php['ban_record_x_deleted'] = 'Запись блокировки %s была удалена';
$lang_banning_php['new_ban_record_created'] = 'Новая запись блокировки была создана';
$lang_banning_php['ban_record_x_already_exists'] = 'Запись блокировки для %s уже существует!';
$lang_banning_php['comment_deleted'] = '%s комментарий, оставленный %s, был удален';
$lang_banning_php['comments_deleted'] = '%s комментариев, оставленных %s, были удалены';
$lang_banning_php['email_field_invalid'] = 'Введите правильный электронный почтовый адерс';
$lang_banning_php['ip_address_field_invalid'] = 'Введите правильный IP адрес (x.x.x.x)';
$lang_banning_php['expiry_field_invalid'] = 'Введите правильную дату окончания (YYYY-MM-DD)';
$lang_banning_php['form_not_submit'] = 'Данные не были переданы - есть ошибки, которые Вам нужно исправить!';
}
...
$lang_bridgemgr_php['error_bridge_file_not_exist'] = 'Отсутствует bridge-файл: %s';
...
$lang_calendar_php['files'] = 'файлов';
}
...
$lang_catmgr_php['category'] = 'Категории';
...
$lang_catmgr_php['no_category'] = '* Нет категории *';
$lang_catmgr_php['group_create_alb'] = 'Группы, которым разрешено создавать альбомы в этой категории';
}
...
$lang_contact_php['title'] = 'Обратная связь';
$lang_contact_php['your_name'] = 'Ваше имя';
$lang_contact_php['your_email'] = 'Ваш адрес электронной почты';
$lang_contact_php['subject'] = 'Тема';
$lang_contact_php['your_message'] = 'Ваше сообщение';
$lang_contact_php['name_field_mandatory'] = 'Пожалуйста, введите Ваше имя'; // js-alert
$lang_contact_php['name_field_invalid'] = 'Пожалуйста, введите Ваше настоящее имя'; // js-alert
$lang_contact_php['email_field_mandatory'] = 'Пожалуйста, введите Ваш адрес электронной почты'; // js-alert
$lang_contact_php['email_field_invalid'] = 'Пожалуйста, введите правильный адрес электронной почты'; // js-alert
$lang_contact_php['subject_field_mandatory'] = 'Пожалуйста, введите понятную тему'; // js-alert
$lang_contact_php['message_field_mandatory'] = 'Пожалуйста, введите Ваше сообщение'; // js-alert
$lang_contact_php['confirmation'] = 'Подтверждение';
$lang_contact_php['email_headline'] = 'Это письмо было послано в %s с помощью формы обратной связи, расположенной по адресу %s, с IP адреса %s';
$lang_contact_php['registered_user'] = 'зарегистрированный пользователь';
$lang_contact_php['guest'] = 'гость';
$lang_contact_php['unknown'] = 'неизвестный';
$lang_contact_php['user_info'] = '%s, назвавшийся %s и с адресом электронной почты %s, написал:';
$lang_contact_php['failed_sending_email'] = 'Неудача при отправке сообщения. Пожалуйста, попытайтесь позднее.';
$lang_contact_php['email_sent'] = 'Ваше сообщение было отправлено.';
}
...
$lang_admin_php['general_settings'] = 'Общие настройки';
$lang_admin_php['language_charset_settings'] = 'Настройка языка и кодировки';
$lang_admin_php['themes_settings'] = 'Настройки тем';
$lang_admin_php['album_list_view'] = 'Отображение списка альбомов';
$lang_admin_php['thumbnail_view'] = 'Отображение миниатюр';
$lang_admin_php['image_view'] = 'Отображение изображений';
$lang_admin_php['comment_settings'] = 'Настройки комментариев';
$lang_admin_php['thumbnail_settings'] = 'Настройки миниатюр';
$lang_admin_php['file_settings'] = 'Настройки файлов';
$lang_admin_php['image_watermarking'] = 'Настройки водяных знаков';
$lang_admin_php['registration'] = 'Регистрация';
$lang_admin_php['user_settings'] = 'Настройки пользователей';
$lang_admin_php['custom_fields_user_profile'] = 'Дополнительные поля для профиля пользователя (оставьте пустыми, если не хотите использовать). Используйте поле 6 для длинных описаний, к примеру, для биографии';
$lang_admin_php['custom_fields_image_description'] = 'Дополнительные поля для описания изображений (оставьте пустыми, если не хотите использовать)';
$lang_admin_php['cookie_settings'] = 'Настройки cookie';
$lang_admin_php['email_settings'] = 'Настройки email';
$lang_admin_php['logging_stats'] = 'Логи и статистика';
$lang_admin_php['maintenance_settings'] = 'Настройки для отладочных работ';
...
$lang_admin_php['restore_cfg_confirm'] = 'Вы действительно хотите восстановить настройки по умолчанию? Этого нельзя будет отменить!'; // js-alert
...
$lang_admin_php['view_a'] = 'Просмотры [возрастание]';
$lang_admin_php['view_d'] = 'Просмотры [убывание]';
$lang_admin_php['th_any'] = 'Наибольшая сторона';
$lang_admin_php['th_ht'] = 'Высота';
$lang_admin_php['th_wd'] = 'Ширина';
$lang_admin_php['th_ex'] = 'Точный';
...
$lang_admin_php['click_collapse'] = 'кликните на секцию, чтобы свернуть';
$lang_admin_php['expand_all'] = 'Развернуть всё';
$lang_admin_php['toggle_all'] = 'Инвертировать всё';
...
$lang_admin_php['collapse_all'] = 'Свернуть всё';
$lang_admin_php['separate_page'] = 'на отдельной странице';
$lang_admin_php['inline'] = 'встроенный';
$lang_admin_php['guests_only'] = 'Только гости';
$lang_admin_php['wm_bottomright'] = 'Внизу справа';
$lang_admin_php['wm_bottomleft'] = 'Внизу слева';
$lang_admin_php['wm_topleft'] = 'Вверху слева';
$lang_admin_php['wm_topright'] = 'Вверху справа';
$lang_admin_php['wm_center'] = 'По центру';
$lang_admin_php['wm_both'] = 'Оба';
$lang_admin_php['wm_original'] = 'Оригинал';
$lang_admin_php['wm_resized'] = 'Измененный';
$lang_admin_php['gallery_name'] = 'Имя галереи';
$lang_admin_php['gallery_description'] = 'Описание галереи';
$lang_admin_php['gallery_admin_email'] = 'Email адрес администратора';
$lang_admin_php['ecards_more_pic_target'] = 'Ссылка на папку Вашей галереи';
$lang_admin_php['ecards_more_pic_target_detail'] = '(с завершающим слэшем на конце, никаких \'index.php\' или подобного на конце)';
$lang_admin_php['home_target'] = 'Ссылка на Вашу домашнюю страницу';
$lang_admin_php['enable_zipdownload'] = 'Разрешить ZIP-скачивание в избранном';
$lang_admin_php['enable_zipdownload_no_textfile'] = 'только избранное';
$lang_admin_php['enable_zipdownload_additional_textfile'] = 'избранное и файл с информацией';
$lang_admin_php['time_offset'] = 'Разница во времени относительно GMT';
$lang_admin_php['time_offset_detail'] = '(текущее время: %s)';
$lang_admin_php['enable_help'] = 'Включить иконки помощи';
$lang_admin_php['enable_help_description'] = 'помощь частично доступна только на английском языке';
$lang_admin_php['clickable_keyword_search'] = 'Включить интерактивные ключевые слова в поиске';
$lang_admin_php['keyword_separator'] = 'Разделитель ключевых слов';
$lang_admin_php['keyword_convert'] = 'Конвертировать разделитель ключевых слов';
$lang_admin_php['enable_plugins'] = 'Включить плагины';
$lang_admin_php['purge_expired_bans'] = 'Автоматическая чистка истёкших блокировок';
$lang_admin_php['only_empty_albums'] = 'Кнопка «Добавить» рядом с раскрывающимся списком альбомов для отображения только пустых альбомов'; // ???
$lang_admin_php['browse_batch_add'] = 'Встроенный проводник в групповом добавлении файлов';
$lang_admin_php['batch_add_hide_existing_files'] = 'Скрыть уже добавленные файлы в интерфейсе группового добавления';
$lang_admin_php['batch_proc_limit'] = 'Количество потоков для группового добавления файлов';
$lang_admin_php['display_thumbs_batch_add'] = 'Отображать миниатюры при групповом добавлении файлов';
$lang_admin_php['lang'] = 'Язык по умолчанию';
$lang_admin_php['language_autodetect'] = 'Автоматическое определение языка';
$lang_admin_php['charset'] = 'Кодировка символов';
// 'previous_next_tab'] = 'Отображать предыдущий/следующий на страницах с закладками';
$lang_admin_php['theme'] = 'Тема';
$lang_admin_php['custom_lnk_name'] = 'Название дополнительной ссылки в меню';
$lang_admin_php['custom_lnk_url'] = 'Адрес дополнительной ссылки в меню';
$lang_admin_php['enable_menu_icons'] = 'Включить иконки в меню';
$lang_admin_php['show_bbcode_help'] = 'Отображать помощь по BBCode';
$lang_admin_php['vanity_block'] = 'Отображать иконки совместимости внизу страницы для тем, которые поддерживают XHTML и CSS';
$lang_admin_php['highlight_multiple'] = 'Чтобы выделить несколько строк, удерживайте клавишу [Ctrl]';
$lang_admin_php['custom_header_path'] = 'Путь к дополнительному файлу верхней части галереи';
$lang_admin_php['custom_footer_path'] = 'Путь к дополнительному файлу нижней части галереи';
$lang_admin_php['browse_by_date'] = 'Включить просмотр по дате';
$lang_admin_php['display_redirection_page'] = 'Отображать страницы c перенаправлением';
$lang_admin_php['main_table_width'] = 'Ширина главной таблицы';
$lang_admin_php['pixels_or_percent'] = 'пиксели или %';
$lang_admin_php['subcat_level'] = 'Количество отображаемых уровней категорий';
$lang_admin_php['albums_per_page'] = 'Количество отображаемых альбомов';
$lang_admin_php['album_list_cols'] = 'Количество колонок для списка альбомов';
$lang_admin_php['alb_list_thumb_size'] = 'Размер миниатюр альбомов';
$lang_admin_php['main_page_layout'] = 'Содержание главной страницы';
$lang_admin_php['first_level'] = 'Отображать миниатюры альбомов первого уровня в категориях';
$lang_admin_php['categories_alpha_sort'] = 'Сортировать категории по алфавиту';
$lang_admin_php['categories_alpha_sort_details'] = '(вместо выбранного порядка сортировки)';
$lang_admin_php['album_sort_order'] = 'Порядок сортировки альбомов';
$lang_admin_php['link_pic_count'] = 'Отображать число присоединенных файлов';
$lang_admin_php['link_last_upload'] = 'Относительное время загрузки связанных файлов в информации об альбоме'; // ???
$lang_admin_php['thumbcols'] = 'Количество колонок на странице с миниатюрами';
$lang_admin_php['thumbrows'] = 'Количество строк на странице с миниатюрами';
$lang_admin_php['max_tabs'] = 'Максимальное количество отображаемых вкладок';
$lang_admin_php['tabs_dropdown'] = 'Отображать выпадающий список всех страниц рядом со вкладками';
$lang_admin_php['caption_in_thumbview'] = 'Отображать под миниатюрой описание файла (в дополнение к названию)';
$lang_admin_php['views_in_thumbview'] = 'Отображать под миниатюрой количество просмотров';
$lang_admin_php['display_comment_count'] = 'Отображать под миниатюрой количество комментариев';
$lang_admin_php['display_uploader'] = 'Отображать под миниатюрой имя пользователя, загрузившего файл';
// 'display_admin_uploader'] = 'Отображать под миниатюрой имена администраторов, загрузивших файл';
$lang_admin_php['display_filename'] = 'Отображать под миниатюрой имя файла';
$lang_admin_php['display_thumbnail_rating'] = 'Отображать под миниатюрой рейтинг';
$lang_admin_php['alb_desc_thumb'] = 'Отображать описание альбома';
$lang_admin_php['thumbnail_to_fullsize'] = 'Переходить от миниатюр сразу к полноразмерным изображениям';
$lang_admin_php['default_sort_order'] = 'Порядок сортировки файлов по умолчанию';
$lang_admin_php['custom_sortorder_thumbs'] = 'Отображение кнопок сортировки на странице миниатюр';
$lang_admin_php['min_votes_for_rating'] = 'Минимальное количество голосов для файла, чтобы он появился в списке \'Лучшие по рейтингу\'';
$lang_admin_php['picture_table_width'] = 'Ширина таблицы для отображения файла';
$lang_admin_php['display_pic_info'] = 'Информация о файле видна по умолчанию';
$lang_admin_php['picinfo_movie_download_link'] = 'Отображать ссылку на скачивание видео в области описания файла';
$lang_admin_php['max_img_desc_length'] = 'Максимальная длина описания файла';
$lang_admin_php['max_com_wlength'] = 'Максимальное количество символов в слове';
$lang_admin_php['display_film_strip'] = 'Показывать диафильм';
$lang_admin_php['max_film_strip_items'] = 'Количество кадров в диафильме';
$lang_admin_php['slideshow_interval'] = 'Интервал слайд-шоу';
$lang_admin_php['milliseconds'] = 'миллисекунды';
$lang_admin_php['slideshow_interval_detail'] = '1 секунда = 1000 миллисекунд';
$lang_admin_php['slideshow_hits'] = 'Считать просмотры в слайд-шоу';
$lang_admin_php['ecard_captcha'] = 'Отображать капчу (визуальное подтверждение) при отправки открытки';
$lang_admin_php['ecard_flash'] = 'Разрешить Flash в открытках';
$lang_admin_php['not_recommended'] = 'не рекомендуется';
$lang_admin_php['recommended'] = 'рекомендуется';
$lang_admin_php['transparent_overlay'] = 'Вставить прозрачное наложение для минимизации краж изображений';
$lang_admin_php['old_style_rating'] = 'Переключится на старую систему рейтинга';
$lang_admin_php['old_style_rating_extra'] = 'Это отключить опцию \'Количество используемых звёзд рейтинга\'';
$lang_admin_php['rating_stars_amount'] = 'Количество используемых звёзд рейтинга для голосования';
$lang_admin_php['rate_own_files'] = 'Пользователи могут голосовать за свои файлы';
$lang_admin_php['filter_bad_words'] = 'Фильтровать плохие слова в комментариях';
$lang_admin_php['enable_smilies'] = 'Разрешить смайлы в комментариях';
$lang_admin_php['disable_comment_flood_protect'] = 'Разрешить несколько последовательных комментариев к одному файлу от одного и того же пользователя';
$lang_admin_php['disable_comment_flood_protect_details'] = '(отключить защиту от флуда)';
$lang_admin_php['max_com_lines'] = 'Максимальное количество строк в комментарии';
$lang_admin_php['max_com_size'] = 'Максимальная длина комментария';
$lang_admin_php['email_comment_notification'] = 'Уведомлять администратора по электронной почте о добавленных комментариях';
$lang_admin_php['comments_sort_descending'] = 'Порядок сортировки комментариев';
$lang_admin_php['comments_per_page'] = 'Комментариев на страницу';
$lang_admin_php['comments_anon_pfx'] = 'Префикс для комментариев анонимных пользователей';
$lang_admin_php['comment_approval'] = 'Комментарии требуют проверки';
$lang_admin_php['display_comment_approval_only'] = 'Отображать только требующие проверки комментарии на странице &quot;Проверка комментариев&quot;';
$lang_admin_php['comment_placeholder'] = 'Отображать замещающий текст конечным пользователям для комментариев ожидающих проверки';
$lang_admin_php['comment_user_edit'] = 'Разрешить пользователям редактировать свои комментарии';
$lang_admin_php['comment_captcha'] = 'Отображать Captcha (визуальное подтверждение) для добавления комментариев';
$lang_admin_php['comment_akismet_enable'] = 'Настройки Akismet';
$lang_admin_php['comment_akismet_enable_description'] = 'Что должно быть сделано, если Akismet отвергает комментарий как спам?';
$lang_admin_php['comment_akismet_applicable_only'] = 'Настройки применимы только после включения Akismet путём ввода действующего API ключа';
$lang_admin_php['comment_akismet_enable_approval'] = 'Разрешить комментарии, которые не прошли проверку Akismet, но отметить их неподтвержденными';
$lang_admin_php['comment_akismet_drop_tell'] = 'Удалить комментарий, который не прошел проверку, и уведомить автора, что он был отвергнут';
$lang_admin_php['comment_akismet_drop_lie'] = 'Удалить комментарий, который не прошел проверку, но уведомить автора (спамера), что он был добавлен';
$lang_admin_php['comment_akismet_api_key'] = 'Akismet API ключ';
$lang_admin_php['comment_akismet_api_key_description'] = 'Оставьте пустым, чтобы отключить Akismet';
$lang_admin_php['comment_akismet_group'] = 'Применять Akismet для комментариев оставленных';
$lang_admin_php['comment_promote_registration'] = 'Просить гостей войти в систему, чтобы оставить комментарии';
$lang_admin_php['thumb_width'] = 'Максимальный размер миниатюры (ширина, если Вы используете &quot;Точный&quot; в &quot;Использовать размер&quot;)';
$lang_admin_php['thumb_use'] = 'Использовать размер';
$lang_admin_php['thumb_use_detail'] = '(ширина, или высота, или наибольшая сторона для миниатюры)';
$lang_admin_php['thumb_height'] = 'Высота миниатюры';
$lang_admin_php['thumb_height_detail'] = '(применяется только, если Вы используете &quot;Точный&quot; в &quot;Использовать размер&quot;)';
$lang_admin_php['movie_audio_document'] = 'видео, аудио, документы';
$lang_admin_php['thumb_pfx'] = 'Префикс для миниатюр';
$lang_admin_php['enable_unsharp'] = 'Чёткость миниатюр: включить маску снижающую резкость ';
$lang_admin_php['unsharp_amount'] = 'Чёткость миниатюр: величина';
$lang_admin_php['unsharp_radius'] = 'Чёткость миниатюр: охват';
$lang_admin_php['unsharp_threshold'] = 'Чёткость миниатюр: пороговый уровень';
$lang_admin_php['jpeg_qual'] = 'Качество для JPEG файлов';
$lang_admin_php['make_intermediate'] = 'Создавать промежуточные изображения';
$lang_admin_php['picture_use'] = 'Использовать размер';
$lang_admin_php['picture_use_detail'] = '(ширина, или высота, или наибольшая сторона для промежуточного изображения)';
$lang_admin_php['picture_use_thumb'] = 'Как миниатюра';
$lang_admin_php['picture_width'] = 'Максимальная ширина или высота промежуточного изображения';
$lang_admin_php['max_upl_size'] = 'Максимальный размер для загружаемых файлов';
$lang_admin_php['kilobytes'] = 'КБ';
$lang_admin_php['pixels'] = 'пикселей';
$lang_admin_php['max_upl_width_height'] = 'Максимальная ширина или высота загружаемых изображений';
$lang_admin_php['auto_resize'] = 'Автоматически изменять размер изображений, которые больше чем максимальная ширина или высота';
$lang_admin_php['fullsize_padding_x'] = 'Горизонтальный отступ для полноразмерного всплывающего окна';
$lang_admin_php['fullsize_padding_y'] = 'Вертикальный отступ для полноразмерного всплывающего окна';
$lang_admin_php['allow_private_albums'] = 'Пользователи могут иметь приватные альбомы';
$lang_admin_php['allow_private_albums_note'] = '(Внимание: если Вы переключите с \'Да\' на \'Нет\', текущие приватные альбомы станут публичными)';
$lang_admin_php['show_private'] = 'Показывать иконку приватного альбома для гостя';
$lang_admin_php['forbiden_fname_char'] = 'Символы, запрещенные в именах файлов';
$lang_admin_php['silly_safe_mode'] = 'Включить &quot;глупый безопасный режим&quot;';
$lang_admin_php['allowed_img_types'] = 'Разрешенные типы изображений';
$lang_admin_php['allowed_mov_types'] = 'Разрешенные типы видео файлов';
$lang_admin_php['media_autostart'] = 'Автоматический просмотр видео';
$lang_admin_php['allowed_snd_types'] = 'Разрешенные типы аудио файлов';
$lang_admin_php['allowed_doc_types'] = 'Разрешенные типы документов';
$lang_admin_php['thumb_method'] = 'Метод изменения размеров изображений';
$lang_admin_php['impath'] = 'Путь к утилите \'convert\' из пакета ImageMagick';
$lang_admin_php['impath_example'] = '(пример /usr/bin/)';
$lang_admin_php['im_options'] = 'Дополнительные параметры командной строки ImageMagick';
$lang_admin_php['read_exif_data'] = 'Считывать EXIF информацию из JPEG файлов';
$lang_admin_php['read_iptc_data'] = 'Считывать IPTC информацию из JPEG файлов';
$lang_admin_php['fullpath'] = 'Директория альбома';
$lang_admin_php['userpics'] = 'Директория для файлов пользователей';
$lang_admin_php['upload_create_album_directory'] = 'Создайте подкаталог для каждого альбома в пользовательских папках';
$lang_admin_php['normal_pfx'] = 'Префикс для промежуточных изображений';
$lang_admin_php['default_dir_mode'] = 'Права по умолчанию для директорий';
$lang_admin_php['default_file_mode'] = 'Права по умолчанию для файлов';
$lang_admin_php['enable_watermark'] = 'Накладывать водяной знак на изображения';
$lang_admin_php['enable_thumb_watermark'] = 'Накладывать водяной знак на миниатюры';
$lang_admin_php['where_put_watermark'] = 'Куда накладывать водяной знак';
$lang_admin_php['which_files_to_watermark'] = 'На какие файлы накладывать водяной знак';
$lang_admin_php['watermark_file'] = 'Какой файл использовать в качестве водяного знака';
$lang_admin_php['watermark_transparency'] = 'Прозрачность для всего изображения';
$lang_admin_php['zero_2_hundred'] = '0-100';
$lang_admin_php['reduce_watermark'] = 'Уменьшать водяной знак, если ширина изображения меньше, чем введенное значение. Это 100% указанная точка. Изменение размера водяного знака прямолинейно (0 чтобы отключить). Формула: новая_ширина_водяного_знака = исходная_ширина_водяного_знака * ( ширина_изображения / данное_значение )';
$lang_admin_php['watermark_transparency_featherx'] = 'Установить цвет прозрачности x';
$lang_admin_php['watermark_transparency_feathery'] = 'Установить цвет прозрачности y';
$lang_admin_php['gd2_only'] = 'GD2 только';
$lang_admin_php['allow_user_registration'] = 'Разрешить регистрацию новых пользователей';
$lang_admin_php['global_registration_pw'] = 'Общий пароль для регистрации';
$lang_admin_php['user_registration_disclaimer'] = 'Отображать заявление об отсутствии гарантий при регистрации';
$lang_admin_php['registration_captcha'] = 'Отображать Captcha (визуальное подтверждение) на странице регистрации';
$lang_admin_php['reg_requires_valid_email'] = 'Регистрация требует проверку подлинности через email';
$lang_admin_php['reg_notify_admin_email'] = 'Уведомлять администратора о регистрации нового пользователя по email';
$lang_admin_php['admin_activation'] = 'Активация регистраций пользователей администратором';
$lang_admin_php['personal_album_on_registration'] = 'Создавать альбом пользователя в персональной галерее во время регистрации';
$lang_admin_php['allow_unlogged_access'] = 'Разрешить доступ без входа (гости или анонимные пользователи)';
$lang_admin_php['thumbnail_intermediate_full'] = 'миниатюры, промежуточные и полноразмерные изображения';
$lang_admin_php['thumbnail_intermediate'] = 'миниатюры и промежуточные изображения';
$lang_admin_php['thumbnail_only'] = 'только миниатюры';
$lang_admin_php['upload_mechanism'] = 'Метод загрузки по умолчанию';
$lang_admin_php['upload_swf'] = 'несколько файлов, основан на Flash';
$lang_admin_php['upload_single'] = 'простой - один файл за раз';
$lang_admin_php['allow_user_upload_choice'] = 'Разрешить пользователям выбирать тип загрузки';
$lang_admin_php['editpics_ignore_newer_than'] = 'Показать ранее загруженные файлы в форме редактирования файлов после загрузки с использованием HTML5/flash';
$lang_admin_php['allow_duplicate_emails_addr'] = 'Разрешить двум пользователям иметь один и тот же email адрес';
$lang_admin_php['upl_notify_admin_email'] = 'Уведомлять администратора об ожидающей подтверждения загрузке пользователя';
$lang_admin_php['user_manager_hide_file_stats'] = 'Скрыть количество файлов и использование дискового пространства в диспетчере пользователей';
$lang_admin_php['allow_memberlist'] = 'Разрешить вошедшим пользователям просматривать список пользователей';
$lang_admin_php['allow_email_change'] = 'Разрешить пользователям изменять их email адрес в профиле';
$lang_admin_php['allow_user_account_delete'] = 'Разрешить пользователям удалять свою учётную запись';
$lang_admin_php['users_can_edit_pics'] = 'Разрешить пользователям вносить изменения в их файлы в публичных галереях';
$lang_admin_php['allow_user_move_album'] = 'Разрешить пользователям перемещать альбомы между разрешенными категориями';
$lang_admin_php['allow_user_album_keyword'] = 'Разрешить пользователям добавлять ключевые слова для альбомов';
$lang_admin_php['allow_user_edit_after_cat_close'] = 'Разрешить пользователям изменять их альбомы в закрытых категориях';
$lang_admin_php['album_uploads_default'] = 'Значение по умолчанию для свойства альбома "Посетители могут загружать файлы"';
$lang_admin_php['login_method_username'] = 'Имя пользователя';
$lang_admin_php['login_method_email'] = 'Email адрес';
$lang_admin_php['login_method_both'] = 'Оба';
$lang_admin_php['login_method'] = 'Как Вы хотите, чтобы Ваши пользователи входили на сайт';
$lang_admin_php['login_threshold'] = 'Количество неудавшихся попыток входа в галерею до получения временной блокировки';
$lang_admin_php['login_threshold_detail'] = '(чтобы предотвратить попытки подбора пароля)';
$lang_admin_php['login_expiry'] = 'Продолжительность временной блокировки';
$lang_admin_php['minutes'] = 'минуты';
$lang_admin_php['report_post'] = 'Включить жалобы администратору';
$lang_admin_php['user_profile1_name'] = 'Имя поля 1 в профиле';
$lang_admin_php['user_profile2_name'] = 'Имя поля 2 в профиле';
$lang_admin_php['user_profile3_name'] = 'Имя поля 3 в профиле';
$lang_admin_php['user_profile4_name'] = 'Имя поля 4 в профиле';
$lang_admin_php['user_profile5_name'] = 'Имя поля 5 в профиле';
$lang_admin_php['user_profile6_name'] = 'Имя поля 6 в профиле';
$lang_admin_php['user_field1_name'] = 'Имя поля 1';
$lang_admin_php['user_field2_name'] = 'Имя поля 2';
$lang_admin_php['user_field3_name'] = 'Имя поля 3';
$lang_admin_php['user_field4_name'] = 'Имя поля 4';
$lang_admin_php['cookie_name'] = 'Имя cookie';
$lang_admin_php['cookie_path'] = 'Путь cookie';
$lang_admin_php['smtp_host'] = 'Адрес сервера SMTP (если пусто, будет использоваться sendmail)';
$lang_admin_php['smtp_username'] = 'Имя пользователя для SMTP';
$lang_admin_php['smtp_password'] = 'Пароль для SMTP';
$lang_admin_php['log_mode'] = 'Режим ведения логов';
$lang_admin_php['log_mode_details'] = 'Все лог файлы ведутся на английском языке.';
$lang_admin_php['log_ecards'] = 'Вести логи для открыток';
$lang_admin_php['log_ecards_detail'] = 'Внимание: ведение логов может иметь правовые последствия. Пользователи должны быть уведомлены во время регистрации, что для отрыток ведутся логи. Так же рекомендуется создать отдельную страницу с политикой конфиденциальности.';
$lang_admin_php['vote_details'] = 'Вести детализированную статистику голосования';
$lang_admin_php['hit_details'] = 'Вести детализированную статистику хитов';
$lang_admin_php['display_stats_on_index'] = 'Отображать статистику на главной странице';
$lang_admin_php['count_file_hits'] = 'Подсчитывать количество просмотров файлов';
$lang_admin_php['count_album_hits'] = 'Подсчитывать количество просмотров альбомов';
$lang_admin_php['count_admin_hits'] = 'Подсчитывать количество просмотров администратором';
$lang_admin_php['debug_mode'] = 'Включить режим отладки';
$lang_admin_php['debug_notice'] = 'Отображать сообщения в режиме отладки';
$lang_admin_php['offline'] = 'Галерея отключена';
$lang_admin_php['display_coppermine_news'] = 'Показывать новости с coppermine-gallery.net';
$lang_admin_php['display_coppermine_detail'] = 'будет отображаться только для администратора';
$lang_admin_php['config_setting_invalid'] = 'Значение, которое Вы установили для &laquo;%s&raquo;, неправильное, пожалуйста, проверьте его.';
$lang_admin_php['config_setting_rangerr'] = 'Значение, которое вы установили для &laquo;%s&raquo; вне допустимого диапазона, пожалуйста, проверьте его.';
$lang_admin_php['config_setting_ok'] = 'Ваше значение для &laquo;%s&raquo; было сохранено.';
$lang_admin_php['contact_form_settings'] = 'Настройки формы обратной связи';
$lang_admin_php['contact_form_guest_enable'] = 'Отображать форму контактов для анонимных пользователей (гостей)';
$lang_admin_php['contact_form_registered_enable'] = 'Отображать форму контактов для зарегистрированных пользователей';
$lang_admin_php['with_captcha'] = 'с проверкой изображением';
$lang_admin_php['without_captcha'] = 'без проверки изображением';
$lang_admin_php['optional'] = 'не обязательное';
$lang_admin_php['mandatory'] = 'обязательное';
$lang_admin_php['contact_form_guest_name_field'] = 'Отображать для гостей поле с именем отправителя ';
$lang_admin_php['contact_form_guest_email_field'] = 'Отображать для гостей поле с email отправителя';
$lang_admin_php['contact_form_subject_field'] = 'Отображать поле с темой';
$lang_admin_php['contact_form_subject_content'] = 'Заголовок для писем, отправленных их формы для контактов';
$lang_admin_php['contact_form_sender_email'] = 'Использовать email отправителя в качестве &quot;От&quot; адреса';
$lang_admin_php['allow_no_link'] = 'разрешить, но не отображать ссылку';
$lang_admin_php['allow_show_link'] = 'разрешить и внедрить, с отображением ссылки';
$lang_admin_php['display_sidebar_user'] = 'Боковая панель для зарегистрированных пользователей';
$lang_admin_php['display_sidebar_guest'] = 'Боковая панель для гостей';
$lang_admin_php['do_not_change'] = 'Не изменяйте это, если Вы не знаете, что делаете!';
$lang_admin_php['reset_to_default'] = 'Сбросить на значения по умолчанию';
$lang_admin_php['no_change_needed'] = 'Изменения не требуются, файл настроек уже установлен по умолчанию';
$lang_admin_php['enabled'] = 'включен';
$lang_admin_php['disabled'] = 'отключен';
$lang_admin_php['none'] = 'нет';
$lang_admin_php['warning_change'] = 'Когда изменяются эти настройки, то будут затронуты только файлы, добавленные после данного изменения, поэтому не рекомендуется изменять эти настройки, если у Вас уже есть файлы в галерее. Несмотря на это Вы можете применить изменения к существующим файлам с помощью "Инструмент администратора (измененные изображения)" из меню администратора.';
$lang_admin_php['warning_exist'] = 'Эти настройки не должны изменяться, если у Вас уже есть файлы в базе данных.';
$lang_admin_php['warning_dont_submit'] = 'Если Вы не уверены, какие последствия несёт изменение данного параметра, не отправляйте форму и ознакомьтесь сначала с документацией.'; // js-alert
$lang_admin_php['warning_just_new_albums'] = 'Эта опция применяется только к новым альбомам и не влияет на существующие альбомы.';
$lang_admin_php['menu_only'] = 'только меню';
$lang_admin_php['everywhere'] = 'везде';
$lang_admin_php['manage_languages'] = 'Менеджер языков';
$lang_admin_php['form_token_lifetime'] = 'Время жизни маркера безопасности';
$lang_admin_php['seconds'] = 'Секунды';
$lang_admin_php['display_reset_boxes_in_config'] = 'Отображать в конфигурации флажки для сброса настроек по умолчанию';
$lang_admin_php['upd_not_needed'] = 'Обновление не требуется.';
}
...
$lang_db_input_php['com_updated'] = 'Комментарий обновлен';
...
$lang_delete_php['orig_pic'] = 'оригинальное изображение';
...
$lang_delete_php['updating_album'] = 'Обновляю альбом ';
$lang_delete_php['moved_picture_to_position'] = 'Переместил изображение %s на позицию %s';
}
...
$lang_picinfo['show_details'] = 'Показать детали';
$lang_picinfo['hide_details'] = 'Спрятать детали';
$lang_picinfo['download_URL'] = 'Прямая ссылка';
$lang_picinfo['movie_player'] = 'Проиграть файл в Вашем приложении по умолчанию.';

$lang_display_comments['comment_x_to_y_of_z'] = '%d к %d от %d';
$lang_display_comments['page'] = 'Страница';
$lang_display_comments['edit_title'] = 'Изменить этот комментарий';
$lang_display_comments['delete_title'] = 'Удалить этот комментарий';
...
$lang_display_comments['pending_approval'] = 'Комментарий будет виден после проверки администратором';
$lang_display_comments['unapproved_comment'] = 'Неодобренный комментарий';
$lang_display_comments['pending_approval_message'] = 'Кто-то разместил здесь комментарий. Он будет виден после проверки администратором.';
$lang_display_comments['approve'] = 'Одобрить комментарий';
$lang_display_comments['disapprove'] = 'Пометить комментарий как непроверенный';
$lang_display_comments['log_in_to_comment'] = 'Комментарии от гостей здесь не разрешены. %sВойдите%s, чтобы разместить Ваш комментарий'; // do not translate the %s placeholders - they will be used as wrappers for the link (<a>)
$lang_display_comments['default_username_message'] = 'Пожалуйста, введите Ваше имя для комментария';
$lang_display_comments['comment_rejected'] = 'Ваш комментарий был отклонён';

$lang_fullsize_popup['click_to_close'] = 'Нажмите на изображение, чтобы закрыть окно';
$lang_fullsize_popup['close_window'] = 'закрыть окно';
}
...
$lang_ecard_php['invalid_email'] = 'Внимание: неправильный email адрес:';
$lang_ecard_php['ecard_title'] = 'Для Вас есть открытка от %s';
$lang_ecard_php['error_not_image'] = 'Только изображения могут быть посланы в качестве открытки.';
$lang_ecard_php['error_not_image_flash'] = 'Только изображения и flash файлы могут быть посланы в качестве открытки.';
...
$lang_editpics_php['approval'] = 'Проверка';
$lang_editpics_php['approved'] = 'Проверен';
$lang_editpics_php['unapproved'] = 'Не проверен';
...
$lang_editpics_php['edit_pic'] = 'Изменить файл';
...
$lang_editpics_php['error_editor_class'] = 'Редактор класса для Вашего метода изменения размера не реализован'; // (???)
$lang_editpics_php['error_document_size'] = 'У документа нет ширины или высоты'; // js-alert
$lang_editpics_php['success_picture'] = 'Изображение успешно сохранено - Вы можете теперь %sзакрыть%s это окно'; // do not translate "%s" here
$lang_editpics_php['success_thumb'] = 'Миниатюра успешно сохранена - Вы можете теперь %sзакрыть%s это окно'; // do not translate "%s" here
$lang_editpics_php['rotate'] = 'Вращать';
$lang_editpics_php['mirror'] = 'Зелкало';
$lang_editpics_php['scale'] = 'Маштаб';
$lang_editpics_php['new_width'] = 'Новая ширина';
$lang_editpics_php['new_height'] = 'Новая высота';
$lang_editpics_php['enable_clipping'] = 'Включить обрезку, сохраните для обрезки';
$lang_editpics_php['jpeg_quality'] = 'Качество отображения JPEG';
$lang_editpics_php['or'] = 'ИЛИ';
$lang_editpics_php['approve_pic'] = 'Одобрить файл';
$lang_editpics_php['approve_all'] = 'Одобрить ВСЕ файлы';
$lang_editpics_php['error_empty'] = 'Альбом пуст';
$lang_editpics_php['error_approval_empty'] = 'Нет больше изображений для проверки';
$lang_editpics_php['error_linked_only'] = 'Альбом содержит только связанный файлы, которые Вы не можете изменить здесь';
$lang_editpics_php['note_approve_public'] = 'Файлы, перемещаемые в публичный альбом, должны быть одобрены администратором.';
$lang_editpics_php['note_approve_private'] = 'Файлы, перемещаемые в приватную галерею, должны быть одобрены администратором.' ;
$lang_editpics_php['note_edit_control'] = 'Файлы, перемещенный в публичный альбомы не смогут быть изменены.';
$lang_editpics_php['confirm_move'] = 'Вы уверены, что хотите переместить эти файлы?'; //js-alert
$lang_editpics_php['success_changes'] = 'Изменения успешно сохранены';
}
...
$lang_groupmgr_php['group_manager'] = 'Менеджер групп';
...
$lang_groupmgr_php['access_level'] = 'Уровень доступа';
$lang_groupmgr_php['thumbnail_intermediate_full'] = 'миниатюры, промежуточные и полноразмерные изображения';
$lang_groupmgr_php['thumbnail_intermediate'] = 'миниатюры и промежуточные изображения';
$lang_groupmgr_php['thumbnail_only'] = 'только миниатюры';
$lang_groupmgr_php['none'] = 'никакого';
}
...
$lang_album_admin_menu['cat_locked'] = 'Данный альбом был заблокирован для изменений';
...
$lang_list_albums['alb_hits'] = 'Альбом просмотрен %s раз';
$lang_list_albums['from_category'] = ' - Из категории: ';
}
...
$lang_install['dbase_create_btn'] = 'Создать';
$lang_install['dbase_create_db'] = 'Создать новую базу данных';
$lang_install['dbase_db_name'] = 'Имя базы данных';
$lang_install['dbase_error'] = 'Ошибка базы данных: ';
$lang_install['dbase_host'] = 'Хост базы данных<br />(обычно подходит localhost)';
$lang_install['dbase_username'] = 'Имя пользователя базы данных';
$lang_install['dbase_password'] = 'Пароль базы данных';
$lang_install['dbase_no_create_db'] = 'Не могу создать базу данных.';
$lang_install['dbase_no_sel_dbs'] = 'Не могу получить список существующих баз данных';
$lang_install['dbase_succ'] = 'Успешное подключение к базе данных';
$lang_install['dbase_tbl_pref'] = 'Префикс базы данных';
$lang_install['dbase_test_connection'] = 'Тестировать соединение';
$lang_install['dbase_wrong_db'] = 'Не могу найти базу данных с названием \'%s\', пожалуйста, проверьте введенное значение';
...
$lang_install['no_dbase_conn'] = 'Не могу создать подключение к базе данных, пожалуйста, проверьте данные настроек %s';
$lang_install['no_dbase_support'] = 'PHP не имеет поддержку %s.';
...
$lang_install['perm_not_ok'] = 'Права для определенных директорий не установлены корректно.<br />Пожалуйста, измените права директорий, перечисленных ниже и помеченных как "Не в порядке".';
...
$lang_install['title_dbase_type'] = 'Выберите движок базы данных';
$lang_install['title_dbase_db_sel'] = 'Выбор базы данных %s';
$lang_install['title_dbase_pop'] = 'Создание структуры базы данных';
$lang_install['title_dbase_user'] = 'Аутентификация пользователя базы данных';
...
// 1.6 dbabstract
$lang_install['not_available'] = 'недоступно';
$lang_install['version_too_old'] = 'версия слишком старая';
// 1.6.08 XML check
$lang_install['no_xml_parser'] = 'В PHP должна быть включена поддержка XML';
...
$lang_login_php['email'] = 'Email адрес';
$lang_login_php['both'] = 'Имя (ник) / Email адрес';
...
$lang_login_php['force_login'] = 'Вы должны войти, чтобы увидеть данную страницу';
$lang_login_php['force_login_title'] = 'Войдите, чтобы продолжить';
}
...
$lang_logout_php['err_not_logged_in'] = 'Вы не осуществили вход в систему!';
}
...
$lang_minibrowser_php['folder'] = 'Папка';
}
...
// ------------------------------------------------------------------------- //
if (defined('MODE_PHP')) {
$lang_mode_php[0] = 'Выключаю отображение инструментов администратора...';
$lang_mode_php[1] = 'Включаю отображение инструментов администратора...';
$lang_mode_php['news_hide'] = 'Прячу новости...';
$lang_mode_php['news_show'] = 'Показываю новости...';
}
...
$lang_modifyalb_php['related_tasks'] = 'Соответствующие задачи';
$lang_modifyalb_php['choose_album'] = 'Выберите альбом';
...
$lang_modifyalb_php['my_gal'] = '* Моя галерея *';
...
$lang_modifyalb_php['can_moderate'] = 'Альбом могут модерировать';
$lang_modifyalb_php['admins_only'] = 'Только администраторами';
...
$lang_modifyalb_php['random_image'] = 'Случайное изображение';
$lang_modifyalb_php['password_protect'] = 'Защитить альбом паролем (Отметьте для выбора пароля)';
}
...
$lang_picmgr_php['confirm_modifs'] = 'Действительно применить изменения?'; // js-alert
...
$lang_picmgr_php['change_album'] = 'Если Вы измените альбом, Ваши изменения будут утеряны!'; // js-alert
$lang_picmgr_php['submit_reminder'] = 'Изменения сортировки не сохранены до тех пор, пока Вы не нажали &quot;Применить изменения&quot;.';
}
...
$lang_pluginmgr_php['confirm_remove'] = 'ВНИМАНИЕ: API плагинов отключено. Вы хотите УДАЛИТЬ ВРУЧНУЮ данный плагин, игнорирую любые действия по очистке?';
$lang_pluginmgr_php['confirm_delete'] = 'Вы уверены, что хотите УДАЛИТЬ этот плагин';
$lang_pluginmgr_php['pmgr'] = 'Менеджер плагинов';
$lang_pluginmgr_php['explanation'] = 'Включить / выключить / управлять плагинами на этой странице.';
$lang_pluginmgr_php['plugin_enabled'] = 'API плагинов включен';
...
$lang_pluginmgr_php['extra'] = 'Дополнительно';
$lang_pluginmgr_php['install_info'] = 'Информация по установке';
$lang_pluginmgr_php['plugin_disabled_note'] = 'API плагинов отключен, поэтому данная операция не разрешена.';
$lang_pluginmgr_php['install'] = 'включить';
$lang_pluginmgr_php['uninstall'] = 'выключить';
$lang_pluginmgr_php['minimum_requirements_not_met'] = 'Не удовлетворяет минимальным требованиям';
$lang_pluginmgr_php['confirm_version'] = 'Не могу определить требования по версии для данного плагина. Обычно это означает, что плагин не был разработан для Вашей версии Coppermine и поэтому может сломать Вашу галерею. Всё равно продолжить (не рекомендуется)?'; // js-alert
$lang_pluginmgr_php['announcement_thread'] = 'Тема объявления';

$lang_pluginmgr_php['plugin_action'] = 'Действие';
$lang_pluginmgr_php['saved_config'] = 'Конфигурация для &laquo;%s&raquo; была сохранена.';
$lang_pluginmgr_php['enable'] = 'Включить';
$lang_pluginmgr_php['disable'] = 'Выключить';
}
...
$lang_rate_pic_php['fav_added'] = 'Изображение было добавлено в избранное';
$lang_rate_pic_php['fav_removed'] = 'Изображение было удалено из избранного';
}
...
$lang_register_php['err_global_pw'] = 'Неправильный глобальный пароль регистрации';
$lang_register_php['err_global_pass_same'] = 'Ваш пароль должен отличаться от глобального пароля регистрации';
$lang_register_php['err_duplicate_email'] = 'Другой пользователь зарегистрировался ранее с email адресом, который Вы указали';
$lang_register_php['err_disclaimer'] = 'Вы должны согласиться с условиями';
...
$lang_register_php['global_registration_pw'] = 'Глобальный пароль регистрации';
...
$lang_register_php['last_uploads'] = 'Последний загруженный файл';
$lang_register_php['last_uploads_detail'] = 'Нажмите, чтобы увидеть все файлы загруженные %s';
$lang_register_php['last_comments'] = 'Последний комментарий';
$lang_register_php['you'] = 'вы';
$lang_register_php['last_comments_detail'] = 'Нажмите, чтобы увидеть все комментарии оставленные %s';
...
$lang_register_php['delete_my_account'] = 'Удалите мою учётную запись';
$lang_register_php['warning_delete'] = 'Внимание: удаление Вашей учётной записи не может быть отменено. %sФайлы, который Вы загрузили%s в публичные галереи, и Ваши %sкомментарии%s не удаляются, когда Вы удаляете Вашу учётную запись! Не смотря на это, файлы, которые Вы загрузили в персональную галерею, будут удалены.'; // The %s-placeholders mustn't be removed, they will later be replaced by the wrappers for the links
$lang_register_php['i_am_sure'] = 'Я уверен, что хочу удалить мою учётную запись пользователя';
$lang_register_php['really_delete'] = 'Вы действительно хотите удалить учётную запись Вашего пользователя?'; // js-alert
$lang_register_php['edit_xs_profile'] = 'Редактировать профиль %s';
$lang_register_php['edit_my_profile'] = 'Редактировать мой профиль';
$lang_register_php['none'] = 'никакой';
$lang_register_php['user_name_banned'] = 'Имя пользователя, которое Вы выбрали, запрещено/заблокировано. Выберите другое имя пользователя';
$lang_register_php['email_address_banned'] = 'Вы заблокированы в данной галерее. Вам запрещено регистрироваться. Уходите!';
$lang_register_php['email_warning1'] = 'Поле с email адресом не должно быть пустым!';
$lang_register_php['email_warning2'] = 'Введенный Вами email адрес некорректен. Проверьте!';
$lang_register_php['username_warning1'] = 'Поле с именем пользователя не должно быть пустым!';
$lang_register_php['username_warning2'] = 'Имя пользователя должно быть не менее двух символов!';
$lang_register_php['password_warning1'] = 'Пароль должно быть не менее двух символов!';
$lang_register_php['password_warning2'] = 'Имя пользователя и пароль должны различаться!';
$lang_register_php['password_verification_warning1'] = 'Пароли не совпадают, пожалуйста, введите их ещё раз!';
$lang_register_php['form_not_submit'] = 'Форма не была отправлена - есть ошибки, которые нужно исправить, чтобы продолжить!';
$lang_register_php['banned'] = 'Заблокирован';
...
$lang_reviewcom_php['approval_a'] = 'Проверка [возрастание]';
$lang_reviewcom_php['approval_d'] = 'Проверка [убывание]';
$lang_reviewcom_php['ip_a'] = 'IP адрес [возрастание]';
$lang_reviewcom_php['ip_d'] = 'IP адрес [убывание]';
$lang_reviewcom_php['akismet_a'] = 'Akismet рейтинг (годные комментарии внизу)';
$lang_reviewcom_php['akismet_d'] = 'Akismet рейтинг (годные комментарии вверху)';
$lang_reviewcom_php['n_comm_appr'] = 'Проверенных комментариев: %s';
$lang_reviewcom_php['n_comm_unappr'] = 'Непроверенных комментариев: %s ';
$lang_reviewcom_php['configuration_changed'] = 'Конфигурация проверки изменена';
$lang_reviewcom_php['only_approval'] = 'отображаться только комментарии, требующие проверку';
$lang_reviewcom_php['approval'] = 'Проверены';
$lang_reviewcom_php['save_changes'] = 'Сохранить изменения';
$lang_reviewcom_php['n_confirm_delete'] = 'Вы действительно хотите удалить выбранные комментарии';
$lang_reviewcom_php['with_selected'] = 'С выбранными';
$lang_reviewcom_php['delete'] = 'удалить';
$lang_reviewcom_php['approve'] = 'подтвердить';
$lang_reviewcom_php['disapprove'] = 'отметить непроверенные';
$lang_reviewcom_php['do_nothing'] = 'ничего не делать';
$lang_reviewcom_php['comment_approved'] = 'Комментарий подтвержден';
$lang_reviewcom_php['comment_unapproved'] = 'Комментарий отмечен непроверенным';
$lang_reviewcom_php['ban_and_delete'] = 'Заблокировать пользователя и удалить комментарии';
$lang_reviewcom_php['akismet_status'] = 'Akismet сказал';
$lang_reviewcom_php['is_spam'] = 'это спам';
$lang_reviewcom_php['is_not_spam'] = 'это не спам';
$lang_reviewcom_php['akismet'] = 'Akismet';
$lang_reviewcom_php['akismet_count'] = 'Akismet на текущий момент нашел для Вас %s спамовых сообщений';
$lang_reviewcom_php['akismet_test_result'] = 'Тестировать результат для Вашего Akismet API ключа %s';
$lang_reviewcom_php['invalid'] = 'неверен';
$lang_reviewcom_php['missing_gallery_url'] = 'Вам необходимо указать ссылку на галерею в конфигурации Coppermine';
$lang_reviewcom_php['unable_to_connect'] = 'Не могу подключиться к akismet.com';
$lang_reviewcom_php['not_found'] = 'Указанная ссылка не была найдена. Возможно структура сайта akismet.com изменилась.';
$lang_reviewcom_php['unknown_error'] = 'Неизвестная ошибка';
$lang_reviewcom_php['error_message'] = 'Полученное сообщение об ошибке';
$lang_reviewcom_php['ip_address'] = 'IP адрес';
}
...
$lang_sidebar_php['sidebar'] = 'Боковая панель';
$lang_sidebar_php['install'] = 'установить';
$lang_sidebar_php['install_explain'] = 'Среди множества полезных методов по быстрому доступу к информации к страницам на данном сайте, мы предоставляем боковые панели для множества популярных браузеров, используемых в различных операционных системах. Здесь Вы можете найти информацию по установке и удалению для поддерживаемых браузеров.';
$lang_sidebar_php['os_browser_detect'] = 'Определение Вашей операционной системы и браузера';
$lang_sidebar_php['os_browser_detect_explain'] = 'Скрипт пытается определить Вашу операционную систему и версию браузера - пожалуйста, подождите. Если авто-определение потерпело неудачу, Вы можете самостоятельно %sотобразить%s все возможные варианты установки боковых панелей.';
$lang_sidebar_php['mozilla'] = 'Mozilla, Firefox, Netscape 6+, Konqueror 3.2+';
$lang_sidebar_php['mozilla_explain'] = 'Если Вы используете Mozilla 0.9.4 и выше, Вы можете %sдобавить нашу боковую панель в Ваш набор%s. Вы можете удалить данную боковую панель из меню "Управление закладками" в Mozilla.';
$lang_sidebar_php['ie_mac'] = 'Internet Explorer 5 и выше в Mac OS';
$lang_sidebar_php['ie_mac_explain'] = 'Если Вы используете Internet Explorer 5 и выше в MacOS, %sоткройте страницу с нашей боковой панелью%s в отдельном окне. В том окне откройте вкладку "Page Holder" в левой стороне окна. Нажмите "Добавить". Если Вы хотите использовать её в дальнейшем, нажмите на "Избранное" и выберите "Добавить в избранное Page Holder".';
$lang_sidebar_php['ie_win'] = 'Internet Explorer 5 и выше в Windows';
$lang_sidebar_php['ie_win_explain'] = 'Если Вы используете Internet Explorer 5 и выше в Windows, Вы можете добавить боковую панель в Вашу панель ссылок, или Вы можете добавить её в Ваше избранное и, нажимая на неё, Вы сможете видеть нашу панель, отображаемую на месте Вашей обычной панели поиска, путём правого-клика %sздесь%s и выбором "Добавить в избранное" из контекстного меню. Данная ссылка не устанавливает нашу панель в качестве Вашего поиска по умолчанию, поэтому никакие изменения в Вашей системе не производятся.';
$lang_sidebar_php['ie7_win'] = 'Internet Explorer 7 в Windows XP/Vista';
$lang_sidebar_php['ie7_win_explain'] = 'Если Вы используете Internet Explorer 7 в Windows, Вы можете добавить всплывающее навигационное окно в Вашу панель ссылок, или Вы можете добавить её в Ваше избранное и, нажимая на неё, Вы сможете видеть нашу панель, отображаемую в качестве всплывающего окна, путём правого-клика %sздесь%s и выбором "Добавить в избранное" из контекстного меню. В предыдущих версиях IE было возможно добавить подлинную боковую панель, но в IE7 Вы не можете сделать этого без использование специальных изменений в реестре. Рекомендуется использовать другой браузер, если Вы хотите использовать подлинную боковую панель.';
$lang_sidebar_php['opera'] = 'Opera 6 и выше';
$lang_sidebar_php['opera_explain'] = 'Если Вы используете Opera, Вы можете %sнажать на эту ссылку, чтобы добавить нашу боковую панель для Вашего сайта%s. Затем отметьте "Отображать в боковой панели". Вы можете удалить боковую панель путём правого-клика на её закладке и выбором "Удалить" из контекстного меню.';
$lang_sidebar_php['additional_options'] = 'Дополнительные настройки';
$lang_sidebar_php['additional_options_explain'] = 'Если у Вас другой браузер, нежели указанный выше, тогда нажмите %sздесь%s, чтобы отобразить все возможные настройки боковой панели.';
$lang_sidebar_php['cannot_add_sidebar'] = 'Боковая панель не может быть добавлена! Ваш браузер не поддерживает данный метод!'; // js-alert
$lang_sidebar_php['search'] = 'Искать';
$lang_sidebar_php['reload'] = 'Перезагрузить';
}
...
$lang_search_new_php['no_album'] = 'альбом не выбран';
$lang_search_new_php['no_file'] = 'файл не выбран';
...
$lang_search_new_php['browse_batch_add'] = 'Встроенный проводник';
$lang_search_new_php['display_thumbs_batch_add'] = 'Отображать миниатюры для предпросмотра';
...
$lang_search_new_php['add_more_folder'] = 'Пакетно-добавить ещё файлов из папки %s';
}
...
$lang_send_activation_php['err_already_logged_in'] = 'Вы уже вошли в систему!';
$lang_send_activation_php['activation_not_required'] = 'Данный сайт не требует активации по email';
$lang_send_activation_php['err_unk_user'] = 'Выбранный пользователь не существует!';
$lang_send_activation_php['resend_act_link'] = 'Выслать ссылку для активации';
$lang_send_activation_php['enter_email'] = 'Введите Ваш email адрес';
$lang_send_activation_php['submit'] = 'Вперёд';
$lang_send_activation_php['failed_sending_email'] = 'Ошибка при попытке отправить письмо со ссылкой для активации';
$lang_send_activation_php['activation_email_sent'] = 'Письмо со ссылкой для активации было послано на %s. Пожалуйста, проверьте Вашу почту, чтобы завершить процесс';
}
...
$lang_stat_details_php['title'] = 'Подробная статистика';
...
$lang_stat_details_php['users'] = 'Статистика пользователя';
...
$lang_stat_details_php['uid'] = 'Пользователь';
...
$lang_stat_details_php['overall_stats'] = 'Общая статистика';
$lang_stat_details_php['stats_by_os'] = 'Статистика по операционным системам';
$lang_stat_details_php['number_of_hits'] = 'Количество просмотров';
$lang_stat_details_php['total'] = 'Всего';
$lang_stat_details_php['stats_by_browser'] = 'Статистика по браузерам';
$lang_stat_details_php['overall_stats_config'] = 'Настройка общей статистики';
$lang_stat_details_php['hit_details'] = 'Вести детализированную статистику просмотров';
$lang_stat_details_php['hit_details_explanation'] = 'Вести детализированную статистику просмотров';
$lang_stat_details_php['vote_details'] = 'Вести детализированную статистику голосования';
$lang_stat_details_php['vote_details_explanation'] = 'Вести детализированную статистику голосования';
$lang_stat_details_php['empty_hits_table'] = 'Очистить всё статистику просмотров';
$lang_stat_details_php['empty_hits_table_confirm'] = 'Вы абсолютно уверены, что хотите удалить ВСЕ записи о просмотрах для ДАННОЙ галереи? Это нельзя отменить!'; // js-alert
$lang_stat_details_php['empty_votes_table'] = 'Очистить всё статистику голосований';
$lang_stat_details_php['empty_votes_table_confirm'] = 'Вы абсолютно уверены, что хотите удалить ВСЕ записи о голосованиях для ДАННОЙ галереи? Это нельзя отменить!'; // js-alert
$lang_stat_details_php['submit'] = 'Подтвердить';
$lang_stat_details_php['upd_success'] = 'Конфигурация Coppermine была обновлена';
$lang_stat_details_php['votes'] = 'голосов';
$lang_stat_details_php['reset_votes_individual'] = 'Сбросить выбранные голоса';
$lang_stat_details_php['reset_votes_individual_confirm'] = 'Вы уверены, что хотите удалить выбранные голосва? Это нельзя отменить!';
$lang_stat_details_php['back_to_intermediate'] = 'Назад к промежуточному просмотру файлов';
$lang_stat_details_php['records_on_page'] = '%s записей на %s страницах';
$lang_stat_details_php['guest'] = 'Гости';
$lang_stat_details_php['not_implemented'] = 'ещё не реализовано';
}
...
$lang_upload_php['restrictions'] = 'Ограничения';
$lang_upload_php['choose_method'] = 'Выберите метод загрузки';
$lang_upload_php['upload_swf'] = 'Несколько файлов - основан на Flash';
$lang_upload_php['upload_single'] = 'обычный - один файл за раз';
...
$lang_upload_php['no_name'] = 'Имя файла не доступно';
$lang_upload_php['no_tmp_name'] = 'Не могу загрузить';
...
$lang_upload_php['allowed_types'] = 'Вам разрешено загружать файлы с данными расширениями:';
$lang_upload_php['allowed_img_types'] = 'Изображения (расширения): %s';
$lang_upload_php['allowed_mov_types'] = 'Видео (расширения): %s';
$lang_upload_php['allowed_doc_types'] = 'Документы (расширения): %s';
$lang_upload_php['allowed_snd_types'] = 'Аудио (расширения): %s';
$lang_upload_php['please_wait'] = 'Пожалуйста, подождите, пока скрипт производит загрузку - это может занять некоторое время';
$lang_upload_php['alternative_upload'] = 'Альтернативный метод загрузки';
$lang_upload_php['err_js_disabled'] = 'Инструмент загрузки Flash не может быть загружен. У Вас должен быть включен JavaScript, чтобы Вы могли использовать flash интерфейс загрузки.';
$lang_upload_php['err_flash_disabled'] = 'Загрузка интерфейса заняла много времени или загрузка завершилась неудачей. Пожалуйста, убедитесь, что Flash плагин включен и что установлена работающая версия Flash плеера.';
$lang_upload_php['err_alternate_method'] = 'Также Вы можете использовать <a href="upload.php?html5=1">HTML5</a> способ для загрузки файлов.';
$lang_upload_php['err_flash_version'] = 'Интерфейс загрузки не может быть загружен. Возможно Вам необходимо установить или обновить Flash плеер. Посетите <a href="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash">Adobe веб-сайт</a>, чтобы получить Flash плеер.';
$lang_upload_php['flash_loading'] = 'Интерфейс загрузки загружается. Пожалуйста, подождите...';
$lang_upload_php['err_no_method'] = 'Должен быть включен хотя бы один плагин загрузки';
$lang_upload_php['auto_orient'] = 'Автоповорот изображения';

$lang_upload_swf_php['browse'] = 'Обзор...';
$lang_upload_swf_php['cancel_all'] = 'Отменить все загрузки';
$lang_upload_swf_php['upload_queue'] = 'Очередь загрузки';
$lang_upload_swf_php['files_uploaded'] = 'файлы загружены';
$lang_upload_swf_php['all_files'] = 'Все файлы';
$lang_upload_swf_php['status_pending'] = 'Ожидание...';
$lang_upload_swf_php['status_uploading'] = 'Загрузка...';
$lang_upload_swf_php['status_complete'] = 'Завершено.';
$lang_upload_swf_php['status_cancelled'] = 'Отменено.';
$lang_upload_swf_php['status_stopped'] = 'Остановлено.';
$lang_upload_swf_php['status_failed'] = 'Загрузка не удалась.';
$lang_upload_swf_php['status_too_big'] = 'Файл слишком большой.';
$lang_upload_swf_php['status_zero_byte'] = 'Не могу загружать пустые файлы.';
$lang_upload_swf_php['status_invalid_type'] = 'Неверный тип файла.';
$lang_upload_swf_php['status_unhandled'] = 'Необработанная ошибка';
$lang_upload_swf_php['status_upload_error'] = 'Ошибка загрузки: ';
$lang_upload_swf_php['status_server_error'] = 'Ошибка сервера (IO)';
$lang_upload_swf_php['status_security_error'] = 'Ошибка безопасности';
$lang_upload_swf_php['status_upload_limit'] = 'Превышен лимит загрузки.';
$lang_upload_swf_php['status_validation_failed'] = 'Ошибка подтверждения. Загрузка пропущена.';
$lang_upload_swf_php['queue_limit'] = 'Вы попытались поставить в очередь слишком много файлов';
$lang_upload_swf_php['upload_limit_1'] = 'Вы достигли лимита для загрузки.';
$lang_upload_swf_php['upload_limit_2'] = 'Вы можете выбрать до %s файлов';
}
// ------------------------------------------------------------------------- //
// Upload plugin(s)
// ------------------------------------------------------------------------- //
if (defined('PLUGINMGR_PHP') || defined('UPLOAD_PHP') || defined('ADMIN_PHP') || defined('UPLOAD_H5A')) {
$lang_plugin_upload['js_require'] = 'ДЛЯ ЭТОГО МЕТОДА ТРЕБУЕТСЯ JAVASCRIPT.';
$lang_plugin_upload['albmSelMsg'] = 'Пожалуйста, сначала выберите альбом.';
$lang_plugin_upload['size_err'] = 'Файл больше максимально допустимого размера.';

// HTML5
$lang_plugin_upload_h5a['plug_desc'] = 'Добавляет возможность одновременной загрузки нескольких файлов в формате HTML5, включая перетаскивание';
$lang_plugin_upload_h5a['plug_info'] = 'Этот плагин предоставляет метод для одновременной загрузки нескольких файлов с использованием HTML5 и javascript в браузерах с поддержкой.';
$lang_plugin_upload_h5a['html5_method'] = 'Несколько файлов - HTML5 (рекомендуется)';
$lang_plugin_upload_h5a['html5upload'] = 'CoreH5A Загрузка';
$lang_plugin_upload_h5a['title'] = 'HTML5 Загрузка';

$lang_plugin_upload_h5a['upldfiles'] = 'Загрузить файлы';
$lang_plugin_upload_h5a['files'] = 'Файлы';
$lang_plugin_upload_h5a['flistitl'] = 'Используйте имя файла в качестве заголовка';
$lang_plugin_upload_h5a['drop_files'] = 'Или перетащите файлы сюда';
$lang_plugin_upload_h5a['files_left'] = 'Файлы в очереди: ';
$lang_plugin_upload_h5a['continue'] = 'Продолжить:';
$lang_plugin_upload_h5a['gotoedit'] = 'Редактировать загруженные файлы';

$lang_plugin_upload_h5a['maxUplSiz'] = 'Максимальный размер загружаемого файла';	//v1.3
$lang_plugin_upload_h5a['select'] = 'Количество одновременных загрузок';
$lang_plugin_upload_h5a['acptmime'] = 'Фильтры типов файлов для выбора из браузера'; // ???
$lang_plugin_upload_h5a['autoedit'] = 'Автоматически перейти к редактированию после успешного завершения загрузки';
$lang_plugin_upload_h5a['incflds'] = 'Включить поля:';
$lang_plugin_upload_h5a['saved'] = 'Ваши настройки были сохранены.';
$lang_plugin_upload_h5a['revert'] = 'Вернуться к настройкам по-умолчанию';	//v1.3

$lang_plugin_upload_h5a['notavail'] = 'НЕДОСТУПНО ДЛЯ ЭТОГО ВЕБ-БРАУЗЕРА';
$lang_plugin_upload_h5a['aborted'] = 'отменено';
$lang_plugin_upload_h5a['type_err'] = 'Невозможно загрузить файл этого типа (расширения)';
$lang_plugin_upload_h5a['extallow'] = 'Разрешены файлы только со следующими расширениями: ';

$lang_plugin_upload_h5a['q_stop'] = 'приостановить очередь';
$lang_plugin_upload_h5a['q_resume'] = 'продолжить очередь';
$lang_plugin_upload_h5a['q_cancel'] = 'отменить очередь';
//v1.3.2 chunked
$lang_plugin_upload_h5a['muf_err'] = 'Ошибка сохранения части #%d для файла %s ( %s %s )';
$lang_plugin_upload_h5a['miss_chnk'] = 'Отсутствующие части файла';
$lang_plugin_upload_h5a['dest_fail'] = 'Невозможно создать результирующий файл: %s';

// swf
$lang_plugin_upload_swf['plug_desc'] = 'Добавляет возможность загрузки нескольких файлов с помощью Flash';
$lang_plugin_upload_swf['plug_info'] = 'Этот плагин предоставляет метод для загрузки нескольких файлов с использованием Flash и JavaScript.';
$lang_plugin_upload_swf['swf_method'] = 'Несколько файлов - Flash';
$lang_plugin_upload_swf['swfupload'] = 'CoreSWF Загрузка';
$lang_plugin_upload_swf['title'] = 'Flash Загрузка';

// single
$lang_plugin_upload_sgl['plug_desc'] = 'Добавляет метод загрузки файлов по одному';
$lang_plugin_upload_sgl['plug_info'] = 'Этот плагин предоставляет метод для загрузки одиночных файлов.';
$lang_plugin_upload_sgl['sgl_method'] = 'Просто - один файл за раз';
$lang_plugin_upload_sgl['sglupload'] = 'CoreSGL Загрузка';
$lang_plugin_upload_sgl['title'] = 'Загрузка одиночного файла';
$lang_plugin_upload_sgl['choose_file'] = 'Пожалуйста, выберите файл.';
}
// ------------------------------------------------------------------------- //
// File usermgr.php
// ------------------------------------------------------------------------- //
...
$lang_usermgr_php['disk_space_quota'] = 'Квота';
...
$lang_usermgr_php['no_latest_upload'] = 'Не загружал никаких файлов';
$lang_usermgr_php['last_comments'] = 'Последний комментарий';
$lang_usermgr_php['no_last_comments'] = 'Не оставил никаких комментариев';
$lang_usermgr_php['comments'] = 'Комментарии';
...
$lang_usermgr_php['send_login_data'] = 'Выслать информацию для входа данному пользователю (Пароль будет послан в письме)';
$lang_usermgr_php['send_login_email_subject'] = 'Информация о Вашей новой учётной записи';
$lang_usermgr_php['failed_sending_email'] = 'Письмо с информацией о входе не может быть отправлено!';
$lang_usermgr_php['view_profile'] = 'Просмотреть профиль';
$lang_usermgr_php['edit_profile'] = 'Изменить профиль';
$lang_usermgr_php['ban_user'] = 'Заблокировать пользователя';
$lang_usermgr_php['user_is_banned'] = 'Пользователь заблокирован';
$lang_usermgr_php['status'] = 'Статус';
$lang_usermgr_php['status_active'] = 'активен';
$lang_usermgr_php['status_inactive'] = 'не активен';
$lang_usermgr_php['total'] = 'Всего';
...
$lang_update_php['title'] = 'Инструмент обновления';
$lang_update_php['welcome_updater'] = 'Добро пожаловать в инструмент обновления Coppermine';
$lang_update_php['could_not_authenticate'] = 'Не могу Вас опознать';
$lang_update_php['provide_admin_account_cpg'] = 'Пожалуйста, предоставьте данные своей учетной записи администратора Coppermine'; // нифига себе!)
$lang_update_php['provide_admin_account_dbase'] = 'Пожалуйста, предоставьте ваши %s данные учетной записи'; // очешуеть! о чём они думают?)
$lang_update_php['try_again'] = 'Попытаться снова';
$lang_update_php['dbase_connect_error'] = 'Не удалось создать %s соединение';
$lang_update_php['dbase_database_error'] = 'Не удалось подключиться к базе данных: %s';
$lang_update_php['dbase_said'] = '%s сообщила'; // ???
$lang_update_php['check_config_file'] = 'Пожалуйста, проверьте детали %s в %s';
$lang_update_php['performing_database_updates'] = 'Произвожу обновления базы данных';
$lang_update_php['performing_file_updates'] = 'Произвожу обновления файлов';
$lang_update_php['already_done'] = 'Уже было сделано';
$lang_update_php['password_encryption'] = 'Шифрование паролей';
$lang_update_php['alb_password_encryption'] = 'Шифрование паролей альбомов';
$lang_update_php['category_tree'] = 'Дерево категорий';
$lang_update_php['authentication_needed'] = 'Требуется аутентификация';
$lang_update_php['username'] = 'Имя (логин)';
$lang_update_php['password'] = 'Пароль';
$lang_update_php['update_completed'] = 'Обновление завершено';
$lang_update_php['check_versions'] = 'Рекомендуется %sпроверить версию Ваших файлов%s, если Вы только что обновились с старой версии Coppermine'; // Leave the %s untouched when translating - it wraps the link
$lang_update_php['start_page'] = 'Если Вы не обновлялись (или не хотите проходить проверку), Вы можете перейти %sна стартовую страницу Вашей галереи%s'; // Leave the %s untouched when translating - it wraps the link
$lang_update_php['errors_encountered'] = 'Произошли следующие ошибки и их необходимо исправить в первую очередь';
$lang_update_php['delete_file'] = 'Удалить %s';
$lang_update_php['could_not_delete'] = 'Не могу удалить из-за отсутствия прав. Удалите файл вручную!';
$lang_update_php['rename_file'] = 'Переименовать %s в %s';
$lang_update_php['could_not_rename'] = 'Не могу переименовать из-за отсутствия прав. Переименуйте файл вручную!';
// 1.6 dbabstract
$lang_update_php['newDbMethod'] = 'Ваша Coppermine Gallery использует метод подключения к базе данных (mysql), который устарел и должен быть изменен. Пожалуйста, выберите альтернативный способ подключения ниже.';
$lang_update_php['not_available'] = 'недоступно';
$lang_update_php['version_too_old'] = 'версия слишком старая';
$lang_update_php['recommended'] = ' (рекомендуется)';
$lang_update_php['current_nr'] = ' (текущая, не рекомендуется)';
$lang_update_php['unable_write_config'] = 'Невозможно записать файл конфигурации';
// 1.6 core upload plugins
$lang_update_php['core_upload_plugs'] = 'Включить основные модули загрузки';
// for scripted upgrade/update mechanism
$lang_update_php['no_zip_extn'] = 'Расширение, предоставляющее архиватор Zip, недоступно';
$lang_update_php['files_placed_title'] = 'Обновленные файлы загружены';
$lang_update_php['files_placed_msg'] = 'Все файлы обновлений были успешно загружены. Нажмите ниже, чтобы завершить обновление.';
$lang_update_php['complete_update'] = 'Полное обновление';
$lang_update_php['select_update'] = 'Пожалуйста, выберите обновление.';
$lang_update_php['not_writeable'] = '<b>Обновление не может быть выполнено</b><br />Следующие директории недоступны для записи: ';
$lang_update_php['available_updates'] = 'Доступные обновления';
$lang_update_php['perform_update'] = 'Выполнить выбранное обновление';
$lang_update_php['no_updates_title'] = 'Нет доступных обновлений';
$lang_update_php['no_updates_msg'] = 'Обновления для вашей версии недоступны';
$lang_update_php['not_found'] = 'Релизы Coppermine не найдены на Github';
$lang_update_php['save_error'] = 'Не удалось сохранить новое обновление. Операция прервана.';
$lang_update_php['pre_warning'] = '<span style="color:red">ПРЕДУПРЕЖДЕНИЕ: Это предварительная версия!</span>';
}
...
// ------------------------------------------------------------------------- //
if (defined('UTIL_PHP')) {
$lang_util_php['title'] = 'Инструменты администратора';
...
$lang_util_php['titles_updated'] = '%s названий обновлено.';
$lang_util_php['updated_successfully'] = 'обновлено успешно';
$lang_util_php['error_create'] = 'ОШИБКА при создании';
$lang_util_php['continue'] = 'Обработать файлы дальше';
...
$lang_util_php['back'] = 'назад к инструментам администратора';
...
$lang_util_php['update_missing'] = 'Обновить только отсутствующие файлы';
...
$lang_util_php['filename_remove'] = 'Удалить окончание (.jpg или другое) и заменить _ (подчеркивание) на пробелы';
...
$lang_util_php['notitle'] = 'Применить только к файлам с пустыми заголовками';
...
$lang_util_php['change_values_title'] = 'Изменить значения (или очистить) заголовок, описание и ключевые слова.';
$lang_util_php['change_values_how'] = 'Установите новые массовые значения для элементов или очистите их.';
$lang_util_php['change_values_title_label'] = 'Заголовок:';
$lang_util_php['change_values_desc_label'] = 'Описаник:';
$lang_util_php['change_values_tags_label'] = 'Ключевые слова (разделяйте точкой с запятой):';
$lang_util_php['change_values_msg_nothing'] = 'Ничего не делать.';
$lang_util_php['change_values_msg_changed'] = 'Внесены изменения в %d значений.'; // ???
$lang_util_php['change_values_msg_error'] = 'Не удалось внести изменения.';
...
$lang_util_php['delete_intermediate_explanation1'] = 'Это удалит промежуточные изображения.';
$lang_util_php['delete_intermediate_explanation2'] = 'Используйте, чтобы освободить место на диске, если Вы отключили в настройках \'Создавать промежуточные изображения\' после того, как Вы уже добавили изображения в галерею.';
$lang_util_php['delete_intermediate_check'] = 'Настройка конфигурации \'Создавать промежуточные изображения\' на текущий момент %s.';
$lang_util_php['no_image'] = '%s был пропущен, потому что это не изображение.';
$lang_util_php['enabled'] = 'включена';
$lang_util_php['disabled'] = 'выключена';
...
$lang_util_php['update_full_normal_thumb'] = 'Всё: полноразмерные, промежуточные и миниатюры';
$lang_util_php['update_full_normal'] = 'Промежуточные и полноразмерные (если доступна оригинальная копия)';
$lang_util_php['update_full'] = 'Только полноразмерные (если доступна оригинальная копия)';
$lang_util_php['delete_back'] = 'Удалить копию оригинального изображения для изображений с водяным знаком';
$lang_util_php['delete_back_explanation'] = 'Это удалить копию оригинального изображения. Вы сохраните некоторое место на диске, но больше не сможете отменить нанесение водяного знака!!! После этого водяной знак будет постоянным.';
$lang_util_php['finished'] = 'Завершено обновление миниатюр/изображений!<br />';
$lang_util_php['autorefresh'] = ' Авто-обновление (больше нет необходимости нажимать кнопку продолжить)';
...
$lang_util_php['reset_success'] = 'Успешно сброшено';
...
$lang_util_php['delete_old'] = 'Удалить файлы, которые старше, чем определенное число дней';
$lang_util_php['delete_old_explanation'] = 'Это удалить файлы, которые старше, чем количество дней, которое Вы указали (полноразмерные, промежуточные, миниатюры). Используйте, чтобы освободить место на диске.';
$lang_util_php['delete_old_warning'] = 'Внимание: файлы, которые Вы указали, будут удалены без каких-либо дальнейших предупреждений!';
$lang_util_php['deleting_old'] = 'Удаляю старые изображения, пожалуйста, подождите...';
$lang_util_php['older_than'] = 'Удалить файлы старше %s дней';
$lang_util_php['del_orig'] = 'Оригинальный файл %s был успешно удален';
$lang_util_php['del_intermediate'] = 'Промежуточное изображение %s было успешно удалено';
$lang_util_php['del_thumb'] = 'Миниатюра %s была успешно удалена';
$lang_util_php['del_error'] = 'Ошибка при удалении %s!';
$lang_util_php['affected_records'] = '%s затронуто записей.';
$lang_util_php['all_albums'] = 'Все альбомы';
$lang_util_php['update_result'] = 'Результаты обновления';
$lang_util_php['incorrect_filesize'] = 'Общий размер файла неверен';
$lang_util_php['database'] = 'База данных: ';
$lang_util_php['bytes'] = ' байтов';
$lang_util_php['actual'] = ' Актуальный: ';
$lang_util_php['updated'] = 'Обновлённый';
$lang_util_php['filesize_error'] = 'Не могу получить объем файла (может быть неверный файл), пропускаю....';
$lang_util_php['skipped'] = 'Пропущен';
$lang_util_php['incorrect_dimension'] = 'Размеры неверны';
$lang_util_php['dimension_error'] = 'Не могу получить размеры файла, пропускаю....';
$lang_util_php['cannot_fix'] = 'Не могу исправить';
$lang_util_php['fullpic_error'] = 'Файл %s не существует!';
$lang_util_php['no_prob_detect'] = 'Проблемы не обнаружены';
$lang_util_php['no_prob_found'] = 'Проблемы не найдены.';
$lang_util_php['keyword_convert'] = 'Конвертировать разделитель ключевых слов';
$lang_util_php['keyword_from_to'] = 'Конвертировать разделитель ключевых слов из %s в %s';
$lang_util_php['keyword_set'] = 'Установить новое значение разделителя ключевых слов';
$lang_util_php['keyword_replace_before'] = 'Перед конвертированием заменить %s на %s';
$lang_util_php['keyword_replace_after'] = 'После конвертирования заменить %s на %s';
$lang_util_php['keyword_replace_values'] = array('_'=>'подчеркивание', '-'=>'дефис', '~'=>'тильда');
$lang_util_php['keyword_explanation'] = 'Это конвертирует разделитель ключевых слов для всех Ваших файлов из одного значения в другое значение. Смотрите документацию для подробностей.';
$lang_util_php['nothing_deleted'] = 'Нечего удалять.';
$lang_util_php['warnings'] = 'Предупреждения';
$lang_util_php['errors'] = 'Ошибки';
$lang_util_php['complete'] = 'Действие завершено';
}
...
$lang_versioncheck_php['not_modified'] = 'не изменен';
...
$lang_versioncheck_php['mandatory_missing'] = 'Отсутствует обязательный файл';
$lang_versioncheck_php['optional'] = 'необязательный';
$lang_versioncheck_php['removed'] = 'удален';
...
$lang_versioncheck_php['hide_images'] = 'Прятать изображения';
$lang_versioncheck_php['no_modification_check'] = 'Не проверять измененные файлы';
...
$lang_versioncheck_php['read'] = 'Чтение';
$lang_versioncheck_php['write'] = 'Запись';
$lang_versioncheck_php['warning'] = 'Внимание';
$lang_versioncheck_php['not_applicable'] = 'Не доступно';
$lang_versioncheck_php['no_repo_title'] = 'Нет данных из репозитория';
$lang_versioncheck_php['no_repo_message'] = 'Не удалось получить информацию о версии из репозитория.';
}
...
$lang_viewlog_php['last_updated'] = 'последнее обновление';
}

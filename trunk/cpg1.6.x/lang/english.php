...
$lang_admin_php['users_can_edit_pics'] = 'Allow users to retain control over their pics in public galleries';
...
$lang_plugin_php['sample_config_description'] = 'This is a sample plugin. It will not do anything particular useful - it is just meant to demonstrate what plugins can do and how to code them. When enabled, it will display some sample text in red.';
$lang_plugin_php['sample_plugin_documentation'] = 'Plugin Documentation';
$lang_plugin_php['sample_plugin_support'] = 'Plugin Support';
$lang_plugin_php['sample_install_explain'] = 'Enter the username (\'foo\') and password (\'bar\') to install';
$lang_plugin_php['sample_install_username'] = 'Username';
$lang_plugin_php['sample_install_password'] = 'Password';
$lang_plugin_php['sample_output'] = 'This is sample data returned from the sample plugin';
}
